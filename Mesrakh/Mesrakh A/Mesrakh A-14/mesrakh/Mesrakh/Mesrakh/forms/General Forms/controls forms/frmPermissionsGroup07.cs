...
namespace Mesrakh
{
    public partial class frmPermissionsGroup07 : Form
    {
        public frmPermissionsGroup07()
        {
            ...
            InitializeComponent();
            Allfrm07ElementsEventsAndProperties(true, true); // جميع عناصر النموذج
        }

        public void Allfrm07ElementsEventsAndProperties(bool Properties, bool Events = false)  //  جميع العناصر
        {
        ...
        private void txt07001002001EventsAndProperties(bool Properties, bool Events = false) // صندوق نص رقم المجموعة  
        {
            ...
            if (Properties == true && Events == false)
            {
                ElementsTools.TextBox_.CustumProperties(txt07001002001);
            }
            else if (Properties == true && Events == true)
            {
                ElementsTools.TextBox_.CustumProperties(txt07001002001, "", ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1, true, true);
            }
        }
        ...
        private void txt07001002002EventsAndProperties(bool Properties, bool Events = false) // صندوق نص اسم المجموعة عربي  
        {
            ...
            if (Properties == true && Events == false)
            {
                ElementsTools.TextBox_.CustumProperties(txt07001002002, "ar-sa");
            }
            else if (Properties == true && Events == true)
            {
                ElementsTools.TextBox_.CustumProperties(txt07001002002, "ar-sa", ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1, true, true);
        ...
        private void txt07001002003EventsAndProperties(bool Properties, bool Events = false) // صندوق نص اسم المجموعة انجليزي  
        {
            ...
            if (Properties == true && Events == false)
            {
                ElementsTools.TextBox_.CustumProperties(txt07001002003, "en-us");
            }
            else if (Properties == true && Events == true)
            {
                ElementsTools.TextBox_.CustumProperties(txt07001002003, "en-us", ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1, true, true);
                    ...
                    try
                    {
                        ...
                        if (Permissions.AccountHavePermission(PermissionObjectes.Manage_User_Group_Permissions, PermissionType.Edit))
                        {
                            ...
                            else
                            {
                                ...
                                //SqlCommand com = new SqlCommand("", ConnectionsTools.ConMesrakhMainDB());
                                //string commandString = @"update TblPermissions set ShowData = @ShowData,AddData = @AddData,EditData = @EditData,DeleteData = @DeleteData where PermissionGroupNo = @PermissionGroupNo and FormNo = @FormNo ";
                                //com.CommandText = commandString;
                                //com.Parameters.Add("@ShowData", SqlDbType.Bit);
                                //com.Parameters.Add("@AddData", SqlDbType.Bit);
                                //com.Parameters.Add("@EditData", SqlDbType.Bit);
                                //com.Parameters.Add("@DeleteData", SqlDbType.Bit);
                                //com.Parameters.Add("@PermissionGroupNo", SqlDbType.Int);
                                //com.Parameters.Add("@FormNo", SqlDbType.Int);
                                //for (int row = 0; row < dgv07001003001.Rows.Count; row++)
                                //{
                                //    com.Parameters["@ShowData"].Value = dgv07001003001.Rows[row].Cells[6].Value.Equals(true || false);
                                //    com.Parameters["@AddData"].Value = dgv07001003001.Rows[row].Cells[7].Value.Equals(true || false);
                                //    com.Parameters["@EditData"].Value = dgv07001003001.Rows[row].Cells[8].Value.Equals(true || false);
                                //    com.Parameters["@DeleteData"].Value = dgv07001003001.Rows[row].Cells[9].Value.Equals(true || false);
                                //    com.Parameters["@PermissionGroupNo"].Value = int.Parse(dgv07001003001.Rows[row].Cells[0].Value.ToString());
                                //    com.Parameters["@FormNo"].Value = int.Parse(dgv07001003001.Rows[row].Cells[3].Value.ToString());
        ...
        {
            string commandString = @"select TblUsersPermissionsGroup.PermissionGroupNo,TblUsersPermissionsGroup.PermissionGroupNameAR,TblUsersPermissionsGroup.PermissionGroupNameEN,TblObjects.ObjectNo,TblObjects.ObjectNameAR,TblObjects.ObjectNameEN,TblPermissions.ShowData,TblPermissions.AddData,TblPermissions.EditData,TblPermissions.DeleteData from TblUsersPermissionsGroup
