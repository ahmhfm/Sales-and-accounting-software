        ...
        private void fillTblOperationUnits()
        {
            try
            {
                ...
                if(TblOperationUnits != null)
                {
                    ...
                    TblOperationUnits = DataTools.DataBases.ReadTabel("select * from TblOperationUnits where ( DeviceNumber = '' or DeviceNumber = null ) and BranchNumber = " + cbx002.SelectedValue);
                }
                else
                {
