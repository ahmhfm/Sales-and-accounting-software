...
public class Cultures
{
    ...
    public static void fillTranslationTable()
    {
        if (tblTranslation is null)
        {
            ...
            tblTranslation.Rows.Add(new string[] { "553", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "554", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "555", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "556", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "557", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "558", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "559", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "560", "", "", "" });
