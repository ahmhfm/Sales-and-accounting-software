            ...
            else if (Properties == true && Events == true)
            {
                ...
                btn004.Click += delegate
                {
                    ...
                    if (result[1] == "succeeded")
                    {
                        ...
                        frm.OperationUnitNumber = (this.Parent.Parent.Parent.Parent.Parent as frmSales23).TblOpenShiftsForThisOperationUnit.Rows[0][5].ToString(); // رقم وحدة العمليات
                        frm.OperationUnitAccountNo = (this.Parent.Parent.Parent.Parent.Parent as frmSales23).TblOperationUnits.Rows[0][4].ToString(); // رقم حساب وحدة العمليات
                        frm.BranchNumber = (this.Parent.Parent.Parent.Parent.Parent as frmSales23).TblOperationUnits.Rows[0][1].ToString(); // رقم الفرع
