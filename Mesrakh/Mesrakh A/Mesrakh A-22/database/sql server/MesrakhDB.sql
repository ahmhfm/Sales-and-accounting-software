    ...
    insert into TblAccounts values (12 ,'أصول متداولة','أصول متداولة','2', 1);
	       ...
	       insert into TblAccounts values (1204 ,'المدينين','المدنين','3',12 );
			     ...
			     insert into TblAccounts values ( 120401,'مدينين المجموعة 1','مدينين المجموعة 1','4', 1204);
							 ...
							 --  /_._5
							 insert into TblAccounts values ( 120401001,'ح/مدين/احمد سالم','ح/مدين/احمد سالم','5',120401 );
	       ...
	       --  /_3
	       insert into TblAccounts values ( 1210,'الأرصدة المدينة الأخرى','الأرصدة المدينة الأخرى','3',12 );

			     --  /_4
			     insert into TblAccounts values ( 121001,'إيرادات مستحقة عند التوريد للزبون','إيرادات مستحقة عند التوريد للزبون','4', 1210);
...
insert into TblAccounts values (4 ,'مصروفات','مصروفات','1',null);
    ...
    insert into TblAccounts values ( 43,'مصاريف تشغيلية','مصاريف تشغيلية','2', 4);
	       ...
	       --  / _3
	       insert into TblAccounts values ( 4302,'رواتب','رواتب','3', 43);

		   	       --  / _4
	              insert into TblAccounts values ( 430201,'رواتب الفرع 1','رواتب الفرع 1','4', 4302);

				  		   --  / _5
	                       insert into TblAccounts values ( 430201001,'ح/راتب /خالد','ح/راتب /خالد','5', 430201);

						   --  / _5
	                       insert into TblAccounts values ( 430201002,'ح/راتب /ايهم','ح/راتب /ايهم','5', 430201);
...
insert into TblStandardAccounts values (6 , 'Cash Flows' , 'التدفقات النقدية' ,'', 6);
...
insert into TblStandardAccounts values (9 , 'Payable bills account' , 'حساب أوراق الدفع' ,'', 1202);
...
insert into TblStandardAccounts values (12 , 'Revenue Account Due On Supply' , 'حساب إيرادات تستحق عند التوريد' ,'', 121001);
