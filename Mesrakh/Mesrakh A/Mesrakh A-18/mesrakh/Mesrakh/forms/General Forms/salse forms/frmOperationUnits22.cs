                ...
                btnSave.Click += delegate
                {
                    try
                    {
                        ...
                        if (Error == "")
                        {
                            ...
                            string[] result = null;
                            object result2 = DataTools.DataBases.Run(ref result, "update TblOperationUnits set  DeviceNumber = @DeviceNumber , AccountNo = @AccountNo  where OperationUnitNumber = @OperationUnitNumber", CommandType.Text, new object[][] { new object[] { "@DeviceNumber", SecurityTools.specialDevices.getCPUID() }, new object[] { "@OperationUnitNumber", cbx003.SelectedValue }, new object[] { "@AccountNo", txt001.Text.Trim().Replace("'","") } });
