                ...
                dgv001.SelectionChanged += delegate
                {
                    try
                    {
                        if (dgv001.Rows.Count > 0)
                        {
                            ...
                            cbx001.SelectedValue = dgv001.SelectedRows[0].Cells[9].Value;
                            txt001002008.Text = dgv001.SelectedRows[0].Cells[10].Value.ToString();

                            txt001002009.Text = dgv001.SelectedRows[0].Cells[11].Value.ToString();
                            txt001002010.Text = dgv001.SelectedRows[0].Cells[12].Value.ToString();
                            txt001002011.Text = dgv001.SelectedRows[0].Cells[13].Value.ToString();
                            txt001002012.Text = dgv001.SelectedRows[0].Cells[14].Value.ToString();
                            txt001002013.Text = dgv001.SelectedRows[0].Cells[15].Value.ToString();
                            txt001002014.Text = dgv001.SelectedRows[0].Cells[16].Value.ToString();
                            txt001002015.Text = dgv001.SelectedRows[0].Cells[17].Value.ToString();
                            txt001002016.Text = dgv001.SelectedRows[0].Cells[18].Value.ToString();
