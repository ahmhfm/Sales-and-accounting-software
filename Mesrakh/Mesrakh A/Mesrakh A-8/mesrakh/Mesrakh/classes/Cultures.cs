...
public class Cultures
{
    ...
    public static void fillTranslationTable()
    {
        if (tblTranslation is null)
        {
            ...
            tblTranslation.Rows.Add(new string[] { "405", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "406", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "407", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "408", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "409", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "410", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "411", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "412", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "413", "", "", "" });
