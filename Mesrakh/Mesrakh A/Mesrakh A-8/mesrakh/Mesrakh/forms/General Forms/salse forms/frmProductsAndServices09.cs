...
namespace Mesrakh
{
    public partial class frmProductsAndServices09 : Form
    {
        ...
        public void AllEventsAndProperties(bool Properties, bool Events = false)  //  جميع العناصر
        {
            ...
            //-------------- الأرفف
            lblTitelShelfesEventsAndProperties(Properties, Events);// أرقام الأرفف
            lbl001003001EventsAndProperties(Properties, Events); // ملصق رقم الرف
            cbx001003001EventsAndProperties(Properties, Events); // قائمة منسدلة للأرفف
            btnAddShelfEventsAndProperties(Properties, Events); // زر اضافة طريقة اتصال
            btnDeleteShelfEventsAndProperties(Properties, Events); // زر حذف أحد الأرفف
            dgvShelfesEventsAndProperties(Properties, Events); // جدول عرض البيانات
        }
        ...
        private void txt002001EventsAndProperties(bool Properties, bool Events = false) // مربع نص رقم السلعة او الخدمة
        {
            if (Properties == true & Events == false)
            {
                ElementsTools.TextBox_.CustumProperties(txt002001, "", 10);
            }
            else if (Properties == true & Events == true)
            {
                ElementsTools.TextBox_.CustumProperties(txt002001, "", 10, ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1, true, true);
            }
        }
        ...
        private void txt002002EventsAndProperties(bool Properties, bool Events = false) // مربع نص إسم السلعة او الخدمة عربي
        {
            if (Properties == true & Events == false)
            {
                ElementsTools.TextBox_.CustumProperties(txt002002, "ar-SA", 100);

            }
            else if (Properties == true & Events == true)
            {
                ElementsTools.TextBox_.CustumProperties(txt002002, "ar-SA", 100, ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1, true, true);
        ...
        private void txt002003EventsAndProperties(bool Properties, bool Events = false) // مربع نص إسم السلعة او الخدمة إنجليزي
        {
            if (Properties == true & Events == false)
            {
                ElementsTools.TextBox_.CustumProperties(txt002003, "en-US", 100);

            }
            else if (Properties == true & Events == true)
            {
                ElementsTools.TextBox_.CustumProperties(txt002003, "en-US", 100, ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1, true, true);
        ...
        private void txt002004EventsAndProperties(bool Properties, bool Events = false) // مربع نص وصف السلعة او الخدمة عربي
        {
            if (Properties == true & Events == false)
            {
                ElementsTools.TextBox_.CustumProperties(txt002004, "ar-SA", 200);

            }
            else if (Properties == true & Events == true)
            {
                ElementsTools.TextBox_.CustumProperties(txt002004, "ar-SA", 200, ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1, true, true);
        ...
        private void txt002005EventsAndProperties(bool Properties, bool Events = false) // مربع نص وصف السلعة او الخدمة إنجليزي
        {
            if (Properties == true & Events == false)
            {
                ElementsTools.TextBox_.CustumProperties(txt002005, "en-US", 200);

            }
            else if (Properties == true & Events == true)
            {
                ElementsTools.TextBox_.CustumProperties(txt002005, "en-US", 200, ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1, true, true);
                ...
                dgv002001.SelectionChanged += delegate
                {
                    try
                    {
                        if (dgv002001.Rows.Count > 0)
                        {
                            ...
                            // تحديث الارفف
                            fillTblShelves();
                            dgvShelfesEventsAndProperties(true);
                        }
                    }
                    catch (Exception ex)
                    {
        ...
        private void txtCategoryNumberEventsAndProperties(bool Properties, bool Events = false) // مربع نص رقم التصنيف 
        {
            if (Properties == true && Events == false)
            {
                ElementsTools.TextBox_.CustumProperties(txtCategoryNumber, "", 10, ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1, true, false, TextBoxType.Int);
            }
            else if (Properties == true && Events == true)
            {
                ElementsTools.TextBox_.CustumProperties(txtCategoryNumber, "", 10, ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1, true, true, TextBoxType.Int);
            }
        }
        ...
        private void lblTitelShelfesEventsAndProperties(bool Properties, bool Events = false) // أرقام الأرفف
        {
            if (Properties == true && Events == false)
            {
                ElementsTools.Lable_.CustumProperties(lblTitelShelfes, "أرقام الأرفف", ColorPropertyName.BackColor_1);
            }
            else if (Properties == true && Events == true)
            {
                ElementsTools.Lable_.CustumProperties(lblTitelShelfes, "أرقام الأرفف", ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1, true, true);
            }
        }

        private void lbl001003001EventsAndProperties(bool Properties, bool Events = false) // ملصق رقم الرف
        {

            // الخصائص
            if (Properties == true && Events == false)
            {
                ElementsTools.Lable_.CustumProperties(lbl001003001, "رقم الرف", ColorPropertyName.BackColor_1);
            }
            else if (Properties == true && Events == true)
            {
                ElementsTools.Lable_.CustumProperties(lbl001003001, "رقم الرف", ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1, true, true);
            }
        }

        private void cbx001003001EventsAndProperties(bool Properties, bool Events = false) // قائمة منسدلة للأرفف
        {
            if (Properties == true && Events == false)
            {
                try
                {
                    if (TblShelvesForCbx.Rows.Count <= 0) fillTblShelves();
                    if (TblShelvesForCbx.Rows.Count > 0)
                    {
                        cbx001003001.DataSource = TblShelvesForCbx;
                        cbx001003001.ValueMember = "ShelfGeneralNo";
                        if (GeneralVariables.cultureCode == "AR")
                        {
                            cbx001003001.DisplayMember = "ShelfCode";
                        }
                        else
                        {
                            cbx001003001.DisplayMember = "ShelfCode";
                        }
                        ElementsTools.ComboBox_.CustumProperties(cbx001003001);
                    }
                }
                catch (Exception ex)
                {
                    frmMessageBox.ShowMessageBox(Cultures.ReturnTranslation("تنبيه"), ex.Message, MessageBoxStatus.Ok);
                    GeneralAction.AddNewNotification("frmProductsAndServices09 >> cbx001003001EventsAndProperties 1", DateTime.Now, ex.Message, ex.Message);
                }

            }
            else if (Properties == true && Events == true)
            {
                fillTblShelves(); // تعبئة جدول انواع طرق الاتصال
                ...
                try
                {
                    ...
                    ElementsTools.ComboBox_.CustumProperties(cbx001003001, "", true, true);

                }
                catch (Exception ex)
                {
                    frmMessageBox.ShowMessageBox(Cultures.ReturnTranslation("تنبيه"), ex.Message, MessageBoxStatus.Ok);
                    GeneralAction.AddNewNotification("frmProductsAndServices09 >> cbx001003001EventsAndProperties 2", DateTime.Now, ex.Message, ex.Message);
                }

                cbx001003001.KeyDown += delegate (object sender, KeyEventArgs e)
                {
                    if (e.KeyData == Keys.Enter) { btnAddShelf.Select(); };
                };
            }
        }

        private void btnAddShelfEventsAndProperties(bool Properties, bool Events = false) // زر اضافة طريقة اتصال
        {
            if (Properties == true && Events == false)
            {
            ...
            else if (Properties == true && Events == true)
            {
                ...
                btnAddShelf.Click += delegate
                {
                    try
                    {
                        if (Permissions.AccountHavePermission(PermissionObjectes.Products_And_Services, PermissionType.Add))
                        {
                            ...
                            if (btnAddShelf.Text == Cultures.ReturnTranslation("إضافة"))
                            {
                                ...
                                cbx001003001.Enabled = true;

                                cbx001003001.SelectedIndex = 0;
                            ...
                            {
                                string check = "";
                                if (cbx001003001.SelectedIndex < 0)
                                {
                                    check += Cultures.ReturnTranslation("رجاء قم بإختيار أحد الأرفف");
                                    cbx001003001.Focus();
                                }
                                else
                                {
                                    bool? SameShelfNo = ElementsTools.DataGridView_.findValueThenSelected(dgvShelfes, ActionType.add, cbx001003001.Text, 4);

                                    if (SameShelfNo == true)
                                    {
                                        check = Cultures.ReturnTranslation("تمت إضافة هذه الرف مسبقاً");
                                    }
                                ...
                                if (check == "")
                                {
                                    ...
                                    cbx001003001.Enabled = false;
                                    //----------

                                    string[] result = null;
                                    object x = DataTools.DataBases.Run(ref result, "insert into TblConnectionTblShelvesAndTblProductsAndServices values (@ShelfGeneralNo , @ProductOrServiceNumber )", CommandType.Text,
                                        new object[][] { new object[] { "@ShelfGeneralNo", cbx001003001.SelectedValue },
                                            new object[] { "@ProductOrServiceNumber", txt002001.Text.Trim() }
                                        });

                                    fillTblShelves(); // تعبئة جدول الارفف
                                    dgvShelfesEventsAndProperties(true);
                                    btnAddShelf.Focus();
                                }
                                else
                        ...
                        {
                            frmMessageBox.ShowMessageBox(Cultures.ReturnTranslation("تنبيه"), Cultures.ReturnTranslation("لا توجد لديك صلاحية للوصول رجاء تواصل مع مدير النظام"), MessageBoxStatus.Ok);
                            GeneralAction.AddNewNotification("frmProductsAndServices09 >> btnAddShelfEventsAndProperties 1", DateTime.Now, "لا توجد لديك صلاحية للوصول رجاء تواصل مع مدير النظام", "You do not have access, please contact the system administrator");
                        }
                    ...
                    {
                        frmMessageBox.ShowMessageBox(Cultures.ReturnTranslation("تنبيه"), ex.Message, MessageBoxStatus.Ok);
                        GeneralAction.AddNewNotification("frmProductsAndServices09 >> btnAddShelfEventsAndProperties 2", DateTime.Now, ex.Message, ex.Message);
                    }
        ...
        private void btnDeleteShelfEventsAndProperties(bool Properties, bool Events = false) // زر حذف أحد الأرفف
        {
            if (Properties == true && Events == false)
            {
            ...
            else if (Properties == true && Events == true)
            {
                ...
                btnDeleteShelf.Click += delegate
                {
                    try
                    {
                        ...
                        {
                            int xxx = 0;
                            if (dgvShelfes.Rows.Count > 0)
                            {
                                if (dgvShelfes.SelectedRows != null)
                                {
                                    if (dgvShelfes.SelectedRows.Count > 0)
                                    {
                                        xxx = int.Parse(dgvShelfes.SelectedRows[0].Cells[0].Value.ToString());
                                    }
                                    else
                                    {
                                        frmMessageBox.ShowMessageBox(Cultures.ReturnTranslation("تنبيه"), Cultures.ReturnTranslation("رجاء قم بتحديد الرف الذي تريد حذفه"), MessageBoxStatus.Ok);
                                        return;
                                    }
                                }
                                else
                            ...
                            {
                                string[] result = null;
                                object r = DataTools.DataBases.Run(ref result, "delete from TblConnectionTblShelvesAndTblProductsAndServices where ConnectionNo = @ConnectionNo", CommandType.Text, new object[][] { new object[] { "@ConnectionNo", xxx } });
                                fillTblShelves(); // تعبئة جدول الارفف
                                dgvShelfesEventsAndProperties(true);
                        ...
                        {
                            frmMessageBox.ShowMessageBox(Cultures.ReturnTranslation("تنبيه"), Cultures.ReturnTranslation("لا توجد لديك صلاحية للوصول رجاء تواصل مع مدير النظام"), MessageBoxStatus.Ok);
                            GeneralAction.AddNewNotification("frmProductsAndServices09 >> btnDeleteShelfEventsAndProperties 1", DateTime.Now, "لا توجد لديك صلاحية للوصول رجاء تواصل مع مدير النظام", "You do not have access, please contact the system administrator");
                        }
                    }
                    catch (Exception ex)
                    {
                        frmMessageBox.ShowMessageBox(Cultures.ReturnTranslation("تنبيه"), ex.Message, MessageBoxStatus.Ok);
                        GeneralAction.AddNewNotification("frmProductsAndServices09 >> btnDeleteShelfEventsAndProperties 2", DateTime.Now, ex.Message, ex.Message);
                    }
        ...
        private void dgvShelfesEventsAndProperties(bool Properties, bool Events = false) // جدول عرض بيانات الارفف
        {
            if (Properties == true && Events == false)
            {
                ...
                try
                {
                    if (TblShelves.Rows.Count > 0)
                    {
                        ...
                        dgvShelfes.DataSource = TblShelves;


                        dgvShelfes.Columns[0].Visible = false;
                        dgvShelfes.Columns[1].Visible = false;
                        dgvShelfes.Columns[2].Visible = false;
                        dgvShelfes.Columns[3].Visible = false;
                        dgvShelfes.Columns[4].HeaderText = Cultures.ReturnTranslation("كود الرف");
                        dgvShelfes.Columns[5].Visible = false;

                        dgvShelfes.Columns[4].AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill;

                        ElementsTools.DataGridView_.CustumProperties(dgvShelfes);
                    }
                    else
                    {
                        dgvShelfes.DataSource = null;
                        dgvShelfes.Rows.Clear();
                        ElementsTools.DataGridView_.CustumProperties(dgvShelfes);
                    }
                }
                catch (Exception ex)
                {
                    frmMessageBox.ShowMessageBox(Cultures.ReturnTranslation("تنبيه"), ex.Message, MessageBoxStatus.Ok);
                    GeneralAction.AddNewNotification("frmProductsAndServices09 >> dgvShelfesEventsAndProperties 1", DateTime.Now, ex.Message, ex.Message);
                }
            ...
            if (Properties == true && Events == true)
            {
                ...
                try
                {
                    if (TblShelves.Rows.Count > 0)
                    {
                        ...
                        ElementsTools.DataGridView_.CustumProperties(dgvShelfes, true, true);
                    }
                    else
                    {
                        dgvShelfes.DataSource = null;
                ...
                {
                    frmMessageBox.ShowMessageBox(Cultures.ReturnTranslation("تنبيه"), ex.Message, MessageBoxStatus.Ok);
                    GeneralAction.AddNewNotification("frmProductsAndServices09 >> dgvShelfesEventsAndProperties 2", DateTime.Now, ex.Message, ex.Message);
                }

                dgvShelfes.SelectionChanged += delegate
                {


                    try
                    {
                            if(dgvShelfes.CurrentRow != null)
                            {
                                cbx001003001.SelectedValue = dgvShelfes.CurrentRow.Cells[3].Value.ToString();
                            }
                    }
                    catch (Exception ex)
                    {
                        frmMessageBox.ShowMessageBox(Cultures.ReturnTranslation("تنبيه"), ex.Message, MessageBoxStatus.Ok);
                        GeneralAction.AddNewNotification("frmProductsAndServices09 >> dgvShelfesEventsAndProperties 3", DateTime.Now, ex.Message, ex.Message);
                    }

                };

                dgvShelfes.DataBindingComplete += delegate
                {
                    ElementsTools.DataGridView_.CustumProperties(dgvShelfes);
                };
            }
        ...
        //------------------------------ جداول البيانات
        DataTable TblShelves = new DataTable(); // جدول الارفف 
        DataTable TblShelvesForCbx = new DataTable(); // جدول قائمة منسدلة الارفف 
        ...
        private void fillTblShelves()
        {
            try
            {
                ...
                if (txt002001.Text.Trim() != "")
                {
                    TblShelves = DataTools.DataBases.ReadTabel("select * from TblConnectionTblShelvesAndTblProductsAndServices inner join  TblShelves on TblShelves.ShelfGeneralNo = TblConnectionTblShelvesAndTblProductsAndServices.ShelfGeneralNo where ProductOrServiceNumber = " + txt002001.Text);
                    //MessageBox.Show(TblShelves.Rows.Count + "");
                }
                TblShelvesForCbx = DataTools.DataBases.ReadTabel("select * from  TblShelves");

            }
            catch (Exception ex)
            {
                frmMessageBox.ShowMessageBox(Cultures.ReturnTranslation("تنبيه"), ex.Message, MessageBoxStatus.Ok);
                GeneralAction.AddNewNotification("frmProductsAndServices09 >> fillTblShelves ", DateTime.Now, ex.Message, ex.Message);
            }
        }
