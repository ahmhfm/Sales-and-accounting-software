...
public class Cultures
{
    ...
    public static void fillTranslationTable()
    {
        if (tblTranslation is null)
        {
            ...
            tblTranslation.Rows.Add(new string[] { "233", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "234", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "235", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "236", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "237", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "238", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "239", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "240", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "241", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "242", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "243", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "244", "", "", "" });
