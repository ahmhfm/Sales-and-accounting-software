...
public class Cultures
{
    ...
    public static void fillTranslationTable()
    {
        if (tblTranslation is null)
        {
            ...
            tblTranslation.Rows.Add(new string[] { "482", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "483", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "484", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "485", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "486", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "487", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "488", "", "", "" });
        }
    }
