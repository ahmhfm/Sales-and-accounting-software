...
public class Cultures
{
    ...
    public static void fillTranslationTable()
    {
        if (tblTranslation is null)
        {
            ...
            tblTranslation.Rows.Add(new string[] { "509", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "510", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "511", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "512", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "513", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "514", "", "", "" });
        }
    }
