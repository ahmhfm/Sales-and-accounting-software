...
namespace Mesrakh
{
    public partial class frmClients19 : Form
    {
        ...
        public void AllEventsAndProperties(bool Properties, bool Events = false)  //  جميع العناصر
        {
            ...
            lbl001002009EventsAndProperties(Properties, Events);  // ملصق الدولة 
            cbx001EventsAndProperties(Properties, Events);  // قائمة منسدلة الدولة
            lbl001002010EventsAndProperties(Properties, Events); // ملصق الرمز البريدي 
            txt001002008EventsAndProperties(Properties, Events); // مربع نص الرمز البريدي 
            lbl001002011EventsAndProperties(Properties, Events); // ملصق إسم المدينة 
            txt001002009EventsAndProperties(Properties, Events); // مربع نص إسم المدينة 
            lbl001002012EventsAndProperties(Properties, Events); // ملصق إسم الحي 
            txt001002010EventsAndProperties(Properties, Events); // مربع نص إسم الحي 
            lbl001002013EventsAndProperties(Properties, Events); // ملصق إسم الشارع 
            txt001002011EventsAndProperties(Properties, Events); // مربع نص إسم الشارع 
            lbl001002014EventsAndProperties(Properties, Events); // ملصق رقم المبنى 
            txt001002012EventsAndProperties(Properties, Events); // مربع نص رقم المبنى 
            lbl001002015EventsAndProperties(Properties, Events); // ملصق الرقم الفرعي 
            txt001002013EventsAndProperties(Properties, Events); // مربع نص رقم المبنى 
            lbl001002016EventsAndProperties(Properties, Events); // ملصق رقم الوحدة 
            txt001002014EventsAndProperties(Properties, Events); // مربع نص رقم الوحدة 
            lbl001002017EventsAndProperties(Properties, Events); // ملصق العنوان المختصر 
            txt001002015EventsAndProperties(Properties, Events); // مربع نص العنوان المختصر 
            lbl001002018EventsAndProperties(Properties, Events); // ملصق رقم الحساب 
            txt001002016EventsAndProperties(Properties, Events); // مربع نص رقم الحساب 
        ...
        private void txt001002002EventsAndProperties(bool Properties = true, bool Events = false) // مربع نص إسم العميل عربي
        {
            ...
            {
                ElementsTools.TextBox_.CustumProperties(txt001002002, cultureInfo,100, ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1, true, true,TextBoxType.String);
        ...
        private void txt001002004EventsAndProperties(bool Properties, bool Events = false) // مربع نص الرقم الضريبي
        {
            ...
            {
                ElementsTools.TextBox_.CustumProperties(txt001002004, cultureInfo,50, ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1, true, true,TextBoxType.Int);
        ...
        private void txt001002006EventsAndProperties(bool Properties, bool Events = false) // مربع نص الفائدة على رأس المال
        {
            ...
            if (Properties == true && Events == false)
            {
                ElementsTools.TextBox_.CustumProperties(txt001002006, cultureInfo,6, ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1, true, false, TextBoxType.Decimal);
            }
            else if (Properties == true && Events == true)
            {
                ElementsTools.TextBox_.CustumProperties(txt001002006, cultureInfo,6, ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1, true, true, TextBoxType.Decimal);

                txt001002006.KeyPress += delegate (object sender, KeyPressEventArgs e)
                {
                    if (txt001002006.TextLength == 3)
                    {
                        if (!char.IsControl(e.KeyChar))
                        {

                            if (e.KeyChar != '.' && !txt001002006.Text.Contains('.'))
                            {
                                e.Handled = true;
                            }
                        }
                ...
                txt001002006.KeyUp += delegate
                {
                    if(txt001002006.TextLength >0)
                    {
                        if (float.Parse(txt001002006.Text) > 100)
                        {
                            frmMessageBox.ShowMessageBox(Cultures.ReturnTranslation("تنبيه"), "خطأ منطقي النسبة أكبر من مائة", MessageBoxStatus.Ok);

                            txt001002006.Text = "100";
                        }
                    }
                };
            }
        ...
        private void txt001002007EventsAndProperties(bool Properties, bool Events = false) // مربع نص إسم ملصق نسبة الشريك من الأرباح 
        {
            ...
            if (Properties == true && Events == false)
            {
                ElementsTools.TextBox_.CustumProperties(txt001002007, cultureInfo, 6, ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1, true, false, TextBoxType.Decimal);
            }
            else if (Properties == true && Events == true)
            {
                ElementsTools.TextBox_.CustumProperties(txt001002007, cultureInfo, 6, ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1, true, true, TextBoxType.Decimal);

                txt001002007.KeyPress += delegate (object sender, KeyPressEventArgs e)
                {
                    if (txt001002007.TextLength == 3)
                    {
                        if (!char.IsControl(e.KeyChar))
                        {

                            if (e.KeyChar != '.' && !txt001002007.Text.Contains('.') )
                            {
                                e.Handled = true;
                            }
                        }
                ...
                txt001002007.KeyUp += delegate
                {
                    if(txt001002007.TextLength > 0)
                    {
                        if (float.Parse(txt001002007.Text) > 100)
                        {
                            frmMessageBox.ShowMessageBox(Cultures.ReturnTranslation("تنبيه"), "خطأ منطقي النسبة أكبر من مائة", MessageBoxStatus.Ok);

                            txt001002007.Text = "100";
                        }
                    }
                };
            }
        ...
        private void lbl001002009EventsAndProperties(bool Properties, bool Events = false) // ملصق الدولة 
        {

            // الخصائص
            if (Properties == true && Events == false)
            {
                ElementsTools.Lable_.CustumProperties(lbl001002009, "الدولة", ColorPropertyName.BackColor_1);
            }
            else if (Properties == true && Events == true)
            {
                ElementsTools.Lable_.CustumProperties(lbl001002009, "الدولة", ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1, true, true);
            }
        }
        private void cbx001EventsAndProperties(bool Properties, bool Events = false) // قائمة منسدلة الدولة
        {
            if (Properties == true && Events == false)
            {
                try
                {
                    ...
                    {
                        cbx001.DataSource = TblCountries;
                        cbx001.ValueMember = "CountryNo";
                        if (GeneralVariables.cultureCode == "AR")
                        {
                            cbx001.DisplayMember = "CountrNameAr";
                        }
                        else
                        {
                            cbx001.DisplayMember = "CountrNameEn";
                        }
                ...
                catch (Exception ex)
                {
                    ...
                    GeneralAction.AddNewNotification("frmClients19 >> cbx001EventsAndProperties ", DateTime.Now, ex.Message, ex.Message);
                }
            ...
            else if (Properties == true && Events == true)
            {
                ...
                cbx001.KeyDown += delegate (object sender, KeyEventArgs e)
                {
        ...
        private void lbl001002010EventsAndProperties(bool Properties, bool Events = false) // ملصق الرمز البريدي 
        {

            if (Properties == true & Events == false)
            {
                ElementsTools.Lable_.CustumProperties(lbl001002010, "الرمز البريدي", ColorPropertyName.BackColor_1);
            }
            else if (Properties == true & Events == true)
            {
                ElementsTools.Lable_.CustumProperties(lbl001002010, "الرمز البريدي", ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1, true, true);
            }
        }

        private void txt001002008EventsAndProperties(bool Properties, bool Events = false) // مربع نص الرمز البريدي 
        {
            string cultureInfo = "";
            if (Properties == true && Events == false)
            {
                ElementsTools.TextBox_.CustumProperties(txt001002008, cultureInfo,20, ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1, true, false);
            }
            else if (Properties == true && Events == true)
            {
                ElementsTools.TextBox_.CustumProperties(txt001002008, cultureInfo,20, ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1, true, true);
        ...
        private void lbl001002011EventsAndProperties(bool Properties, bool Events = false) // ملصق إسم المدينة 
        {

            if (Properties == true & Events == false)
            {
                ElementsTools.Lable_.CustumProperties(lbl001002011, "المدينة", ColorPropertyName.BackColor_1);
            }
            else if (Properties == true & Events == true)
            {
                ElementsTools.Lable_.CustumProperties(lbl001002011, "المدينة", ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1, true, true);
            }
        }

        private void txt001002009EventsAndProperties(bool Properties, bool Events = false) // مربع نص إسم المدينة 
        {
            string cultureInfo = "";
            if (Properties == true && Events == false)
            {
                ElementsTools.TextBox_.CustumProperties(txt001002009, cultureInfo, 20, ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1, true, false);
            }
            else if (Properties == true && Events == true)
            {
                ElementsTools.TextBox_.CustumProperties(txt001002009, cultureInfo, 20, ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1, true, true);
        ...
        private void lbl001002012EventsAndProperties(bool Properties, bool Events = false) // ملصق إسم الحي 
        {

            if (Properties == true & Events == false)
            {
                ElementsTools.Lable_.CustumProperties(lbl001002012, "إسم الحي", ColorPropertyName.BackColor_1);
            }
            else if (Properties == true & Events == true)
            {
                ElementsTools.Lable_.CustumProperties(lbl001002012, "إسم الحي", ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1, true, true);
            }
        }

        private void txt001002010EventsAndProperties(bool Properties, bool Events = false) // مربع نص إسم الحي 
        {
            string cultureInfo = "";
            if (Properties == true && Events == false)
            {
                ElementsTools.TextBox_.CustumProperties(txt001002010, cultureInfo, 20, ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1, true, false);
            }
            else if (Properties == true && Events == true)
            {
                ElementsTools.TextBox_.CustumProperties(txt001002010, cultureInfo, 20, ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1, true, true);

                txt001002010.KeyDown += delegate (object sender, KeyEventArgs e)
                {
                    if (e.KeyData == Keys.Enter) { txt001002011.Select(); };
                };
            }
        }


        private void lbl001002013EventsAndProperties(bool Properties, bool Events = false) // ملصق إسم الشارع 
        {

            if (Properties == true & Events == false)
            {
                ElementsTools.Lable_.CustumProperties(lbl001002013, "إسم الشارع", ColorPropertyName.BackColor_1);
            }
            else if (Properties == true & Events == true)
            {
                ElementsTools.Lable_.CustumProperties(lbl001002013, "إسم الشارع", ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1, true, true);
            }
        }

        private void txt001002011EventsAndProperties(bool Properties, bool Events = false) // مربع نص إسم الشارع 
        {
            string cultureInfo = "";
            if (Properties == true && Events == false)
            {
                ElementsTools.TextBox_.CustumProperties(txt001002011, cultureInfo, 20, ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1, true, false);
            }
            else if (Properties == true && Events == true)
            {
                ElementsTools.TextBox_.CustumProperties(txt001002011, cultureInfo, 20, ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1, true, true);

                txt001002011.KeyDown += delegate (object sender, KeyEventArgs e)
                {
                    if (e.KeyData == Keys.Enter) { txt001002012.Select(); };
                };
            }
        }


        private void lbl001002014EventsAndProperties(bool Properties, bool Events = false) // ملصق رقم المبنى 
        {

            if (Properties == true & Events == false)
            {
                ElementsTools.Lable_.CustumProperties(lbl001002014, "رقم المبنى", ColorPropertyName.BackColor_1);
            }
            else if (Properties == true & Events == true)
            {
                ElementsTools.Lable_.CustumProperties(lbl001002014, "رقم المبنى", ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1, true, true);
            }
        }

        private void txt001002012EventsAndProperties(bool Properties, bool Events = false) // مربع نص رقم المبنى 
        {
            string cultureInfo = "";
            if (Properties == true && Events == false)
            {
                ElementsTools.TextBox_.CustumProperties(txt001002012, cultureInfo, 20, ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1, true, false);
            }
            else if (Properties == true && Events == true)
            {
                ElementsTools.TextBox_.CustumProperties(txt001002012, cultureInfo, 20, ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1, true, true);

                txt001002012.KeyDown += delegate (object sender, KeyEventArgs e)
                {
                    if (e.KeyData == Keys.Enter) { txt001002013.Select(); };
                };
            }
        }


        private void lbl001002015EventsAndProperties(bool Properties, bool Events = false) // ملصق الرقم الفرعي 
        {

            if (Properties == true & Events == false)
            {
                ElementsTools.Lable_.CustumProperties(lbl001002015, "الرقم الفرعي", ColorPropertyName.BackColor_1);
            }
            else if (Properties == true & Events == true)
            {
                ElementsTools.Lable_.CustumProperties(lbl001002015, "الرقم الفرعي", ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1, true, true);
            }
        }

        private void txt001002013EventsAndProperties(bool Properties, bool Events = false) // مربع نص رقم المبنى 
        {
            string cultureInfo = "";
            if (Properties == true && Events == false)
            {
                ElementsTools.TextBox_.CustumProperties(txt001002013, cultureInfo, 20, ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1, true, false);
            }
            else if (Properties == true && Events == true)
            {
                ElementsTools.TextBox_.CustumProperties(txt001002013, cultureInfo, 20, ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1, true, true);

                txt001002013.KeyDown += delegate (object sender, KeyEventArgs e)
                {
                    if (e.KeyData == Keys.Enter) { txt001002014.Select(); };
                };
            }
        }


        private void lbl001002016EventsAndProperties(bool Properties, bool Events = false) // ملصق رقم الوحدة 
        {

            if (Properties == true & Events == false)
            {
                ElementsTools.Lable_.CustumProperties(lbl001002016, "رقم الوحدة", ColorPropertyName.BackColor_1);
            }
            else if (Properties == true & Events == true)
            {
                ElementsTools.Lable_.CustumProperties(lbl001002016, "رقم الوحدة", ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1, true, true);
            }
        }

        private void txt001002014EventsAndProperties(bool Properties, bool Events = false) // مربع نص رقم الوحدة 
        {
            string cultureInfo = "";
            if (Properties == true && Events == false)
            {
                ElementsTools.TextBox_.CustumProperties(txt001002014, cultureInfo, 20, ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1, true, false);
            }
            else if (Properties == true && Events == true)
            {
                ElementsTools.TextBox_.CustumProperties(txt001002014, cultureInfo, 20, ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1, true, true);

                txt001002014.KeyDown += delegate (object sender, KeyEventArgs e)
                {
                    if (e.KeyData == Keys.Enter) { txt001002015.Select(); };
                };
            }
        }

        private void lbl001002017EventsAndProperties(bool Properties, bool Events = false) // ملصق العنوان المختصر 
        {

            if (Properties == true & Events == false)
            {
                ElementsTools.Lable_.CustumProperties(lbl001002017, "العنوان المختصر", ColorPropertyName.BackColor_1);
            }
            else if (Properties == true & Events == true)
            {
                ElementsTools.Lable_.CustumProperties(lbl001002017, "العنوان المختصر", ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1, true, true);
            }
        }

        private void txt001002015EventsAndProperties(bool Properties, bool Events = false) // مربع نص العنوان المختصر 
        {
            string cultureInfo = "";
            if (Properties == true && Events == false)
            {
                ElementsTools.TextBox_.CustumProperties(txt001002015, cultureInfo, 20, ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1, true, false);
            }
            else if (Properties == true && Events == true)
            {
                ElementsTools.TextBox_.CustumProperties(txt001002015, cultureInfo, 20, ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1, true, true);

                txt001002015.KeyDown += delegate (object sender, KeyEventArgs e)
                {
                    if (e.KeyData == Keys.Enter) { txt001002016.Select(); };
                };
            }
        }


        private void lbl001002018EventsAndProperties(bool Properties, bool Events = false) // ملصق رقم الحساب 
        {

            if (Properties == true & Events == false)
            {
                ElementsTools.Lable_.CustumProperties(lbl001002018, "رقم الحساب", ColorPropertyName.BackColor_1);
            }
            else if (Properties == true & Events == true)
            {
                ElementsTools.Lable_.CustumProperties(lbl001002018, "رقم الحساب", ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1, true, true);
            }
        }

        private void txt001002016EventsAndProperties(bool Properties, bool Events = false) // مربع نص رقم الحساب 
        {
            string cultureInfo = "";
            if (Properties == true && Events == false)
            {
                ElementsTools.TextBox_.CustumProperties(txt001002016, cultureInfo, 10, ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1, true, false, TextBoxType.Int);
            }
            else if (Properties == true && Events == true)
            {
                ElementsTools.TextBox_.CustumProperties(txt001002016, cultureInfo, 10, ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1, true, true , TextBoxType.Int);

                txt001002016.KeyDown += delegate (object sender, KeyEventArgs e)
                {
                    ...
                    try
                    {
                        if (Permissions.AccountHavePermission(PermissionObjectes.Clients, PermissionType.Add))
                        {
                            ...
                            if (btn001002001.Text == Cultures.ReturnTranslation("جديد"))
                            {
                                ...
                                txt001002011.Enabled = true;
                                txt001002012.Enabled = true;
                                txt001002013.Enabled = true;
                                txt001002014.Enabled = true;
                                txt001002015.Enabled = true;
                                txt001002016.Enabled = true;
                            ...
                            else
                            {
                                ...
                                txt001002011.Enabled = false;
                                txt001002012.Enabled = false;
                                txt001002013.Enabled = false;
                                txt001002014.Enabled = false;
                                txt001002015.Enabled = false;
                                txt001002016.Enabled = false;
                        ...
                        if (txt001002001.Text.Trim() == "")
                        {
                            ...
                            if (Error == "")
                            {
                                ...
                                DataTools.DataBases.Run(ref result00, "insert into TblClients values " +
                                    "(@ClientNameAR,@ClientNameEN,@Customer,@Supplier,@TaxNo,@OtherDetails,@InterestOnCapital,@PartnersShareOfProfits,@ConnectingMethodsOfCommunicationNO,@CountryNo ,@ZipCode ,@CityName ,@DistrictName ,@StreetName ,@BuildingNo ,@SecondaryNo ,@UnitNumber ,@ShortAddress ,@AccountNo )", CommandType.Text, new object[][] { 
                                    new object[] { "@ClientNameAR", txt001002002.Text.Trim().Replace("'","") }, 
                                    new object[] { "@ClientNameEN", txt001002003.Text.Trim().Replace("'","") },
                                    new object[] { "@Customer", cbCustomer.Checked },
                                    new object[] { "@Supplier", cbSupplier.Checked },
                                    new object[] { "@TaxNo", txt001002004.Text.Trim().Replace("'","") },
                                    new object[] { "@OtherDetails", txt001002005.Text.Trim().Replace("'","") },
                                    new object[] { "@InterestOnCapital", txt001002006.Text.Trim().Replace("'","") },
                                    new object[] { "@PartnersShareOfProfits", txt001002007.Text.Trim().Replace("'","")},
                                    new object[] { "@ConnectingMethodsOfCommunicationNO", ConnectingMethodsOfCommunicationNO},
                                    new object[] { "@CountryNo", cbx001.SelectedValue} ,
                                    new object[] { "@ZipCode", txt001002008.Text.Trim().Replace("'", "") } ,
                                    new object[] { "@CityName", txt001002009.Text.Trim().Replace("'", "") } ,
                                    new object[] { "@DistrictName", txt001002010.Text.Trim().Replace("'", "") } ,
                                    new object[] { "@StreetName", txt001002011.Text.Trim().Replace("'", "") } ,
                                    new object[] { "@BuildingNo", txt001002012.Text.Trim().Replace("'", "") } ,
                                    new object[] { "@SecondaryNo", txt001002013.Text.Trim().Replace("'", "") } ,
                                    new object[] { "@UnitNumber", txt001002014.Text.Trim().Replace("'", "") } ,
                                    new object[] { "@ShortAddress", txt001002015.Text.Trim().Replace("'", "") } ,
                                    new object[] { "@AccountNo", txt001002016.Text.Trim().Replace("'", "") } 
                                    });
                        ...
                        else
                        {
                            ...
                            if (Error == "")
                            {
                                ...
                                DataTools.DataBases.Run(ref result00, "update TblClients set " +
                                    " ClientNameAR = @ClientNameAR,ClientNameEN = @ClientNameEN, Customer = @Customer,Supplier = @Supplier,TaxNo = @TaxNo,OtherDetails = @OtherDetails,InterestOnCapital = @InterestOnCapital,PartnersShareOfProfits = @PartnersShareOfProfits , CountryNo = @CountryNo ,ZipCode = @ZipCode ,CityName = @CityName ,DistrictName = @DistrictName ,StreetName = @StreetName ,BuildingNo = @BuildingNo ,SecondaryNo = @SecondaryNo ,UnitNumber = @UnitNumber ,ShortAddress = @ShortAddress ,AccountNo = @AccountNo   where ClientsNo = @ClientsNo ", CommandType.Text, new object[][] {
                                    new object[] { "@ClientsNo", txt001002001.Text.Trim().Replace("'", "") } ,
                                    new object[] { "@ClientNameAR", txt001002002.Text.Trim().Replace("'", "") },
                                    new object[] { "@ClientNameEN", txt001002003.Text.Trim().Replace("'", "") },
                                    new object[] { "@Customer", cbCustomer.Checked },
                                    new object[] { "@Supplier", cbSupplier.Checked },
            ...
            if (Properties == true && Events == false)
            {
                try
                {
                    ...
                    if (TblClients.Rows.Count > 0)
                    {
                        ...
                        dgv001.Columns[10].Visible = false;
                        dgv001.Columns[11].Visible = false;
                        dgv001.Columns[12].Visible = false;
                        dgv001.Columns[13].Visible = false;
                        dgv001.Columns[14].Visible = false;
                        dgv001.Columns[15].Visible = false;
                        dgv001.Columns[16].Visible = false;
                        dgv001.Columns[17].Visible = false;
                        dgv001.Columns[18].Visible = false;
                        dgv001.Columns[19].Visible = false;
                ...
                dgv001.SelectionChanged += delegate
                {
                    try
                    {
                        if (dgv001.Rows.Count > 0)
                        {
                            ...
                            cbx001.SelectedValue = dgv001.SelectedRows[0].Cells[10].Value;
                            txt001002008.Text = dgv001.SelectedRows[0].Cells[11].Value.ToString();

                            txt001002009.Text = dgv001.SelectedRows[0].Cells[12].Value.ToString();
                            txt001002010.Text = dgv001.SelectedRows[0].Cells[13].Value.ToString();
                            txt001002011.Text = dgv001.SelectedRows[0].Cells[14].Value.ToString();
                            txt001002012.Text = dgv001.SelectedRows[0].Cells[15].Value.ToString();
                            txt001002013.Text = dgv001.SelectedRows[0].Cells[16].Value.ToString();
                            txt001002014.Text = dgv001.SelectedRows[0].Cells[17].Value.ToString();
                            txt001002015.Text = dgv001.SelectedRows[0].Cells[18].Value.ToString();

                            txt001002016.Text = dgv001.SelectedRows[0].Cells[19].Value.ToString();
        ...
        DataTable TblCountries = new DataTable(); // جدول الدول 
        ...
        private void fillTblAccounts()// تعبئة جدول الحسابات المحاسبية
        {
            try
            {
        ...
        private void fillTblCountries()// تعبئة جدول الدول
        {
            try
            {
                if (TblCountries is null) TblCountries = new DataTable();
                if (TblCountries.Rows.Count > 0) { TblCountries.Rows.Clear(); }

                TblCountries = DataTools.DataBases.ReadTabel("select * from TblCountries");
                if(TblCountries == null )
                {
                    frmMessageBox.ShowMessageBox(Cultures.ReturnTranslation("تنبيه"), Cultures.ReturnTranslation("رجاء قم بإضافة بعض الدول"), MessageBoxStatus.Ok);
                }
                else 
                {
                    if(TblCountries.Rows.Count == 0)
                    {
                        frmMessageBox.ShowMessageBox(Cultures.ReturnTranslation("تنبيه"), Cultures.ReturnTranslation("رجاء قم بإضافة أسماء بعض الدول"), MessageBoxStatus.Ok);
                    }
                }
            }
            catch (Exception ex)
            {
                frmMessageBox.ShowMessageBox(Cultures.ReturnTranslation("تنبيه"), ex.Message, MessageBoxStatus.Ok);
                GeneralAction.AddNewNotification("frmAccounts11 >> fillTblCountry ", DateTime.Now, ex.Message, ex.Message);
            }
        }
