...
namespace Mesrakh
{
    public partial class frmproductAndServicesDetails14 : Form  // نموذج وحدات القياس والتغليف
    {
        ...
        public void AllEventsAndProperties(bool Properties, bool Events = false)  //  جميع العناصر
        {
            ...
            lbl08001002010EventsAndProperties(Properties, Events); // ملصق أسلوب إحتساب السعر 
            ...
            cbx001002006EventsAndProperties(Properties, Events); // قائمة منسدلة أسلوب إحتساب السعر
        ...
        private void txt08001002007EventsAndProperties(bool Properties, bool Events = false) // مربع نص الموديل أو وصف السلعة عربي
        {
            if (Properties == true & Events == false)
            {
                ElementsTools.TextBox_.CustumProperties(txt08001002007, "ar-SA");

            }
            else if (Properties == true & Events == true)
            {
                ElementsTools.TextBox_.CustumProperties(txt08001002007, "ar-SA", ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1, true, true);
        ...
        private void txt08001002004EventsAndProperties(bool Properties, bool Events = false) // مربع نص الموديل او وصف السلعة إنجليزي
        {
            ...
            else if (Properties == true & Events == true)
            {
                ...
                {
                    if (e.KeyData == Keys.Enter) { cbx001002006.Select(); };
                };
        ...
        //***************
        private void lbl08001002010EventsAndProperties(bool Properties, bool Events = false) // ملصق أسلوب إحتساب السعر 
        {

            if (Properties == true & Events == false)
            {
                ElementsTools.Lable_.CustumProperties(lbl08001002010, "أسلوب إحتساب السعر", ColorPropertyName.BackColor_1);
            }
            else if (Properties == true & Events == true)
            {
                ElementsTools.Lable_.CustumProperties(lbl08001002010, "أسلوب إحتساب السعر", ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1, true, true);
            }
        }



        private void cbx001002006EventsAndProperties(bool Properties, bool Events = false) // قائمة منسدلة أسلوب إحتساب السعر
        {
            if (Properties == true && Events == false)
            {
                try
                {
                    ...
                    cbx001002006.Items.Add("الفئات السعرية");
                    cbx001002006.Items.Add("نسبة ربح من سعر التكلفة");
            ...
            else if (Properties == true && Events == true)
            {
                ...
                try
                {
                    ...
                    cbx001002006.Items.Add("الفئات السعرية");
                    cbx001002006.Items.Add("نسبة ربح من سعر التكلفة");
                    ElementsTools.ComboBox_.CustumProperties(cbx001002006,"",true,true);
                }
                catch (Exception ex)
                {
                    frmMessageBox.ShowMessageBox(Cultures.ReturnTranslation("تنبيه"), ex.Message, MessageBoxStatus.Ok);
                ...
                btn08001002001.Click += delegate
                {
                    ...
                    if (Permissions.AccountHavePermission(PermissionObjectes.product_And_Services_Details, PermissionType.Add))
                    {
                        ...
                        if (btn08001002001.Text == Cultures.ReturnTranslation("جديد"))
                        {
                            ...
                            if (cbx001002006 != null && cbx001002006.Items.Count > 0) cbx001002006.SelectedIndex = 0;
                        ...
                        if ( btn08001002001.Text == Cultures.ReturnTranslation("إلغاء")) // إضافة
                        {
                            ...
                            if (Error == "")
                            {
                                ...
                                CommandType.StoredProcedure, new object[][] {
                                    ...
                                    , new object[] { "@PriceCalculationMethod ", cbx001002006.Text }
                            ...
                            if (Error == "")
                            {
                                ...
                                if (CircleElementsTest == false)
                                {
                                    ...
                                    if (result[1] == "succeeded")
                                    {
                                        ...
                                        TblproductAndServicesDetails.Rows[rowIndex][12] = cbx001002006.Text;
                                        ...
                                        TblMeasureAndEncapsulationUnitsForCbx.Rows[rowIndex][12] = cbx001002006.Text;
                    ...
                    try
                    {
                        if (dgv08001.Rows.Count > 0)
                        {
                            ...
                            if (cbx001002006 != null)
                            {
                                ...
                                {
                                    if (dgv08001.SelectedRows[0].Cells[11].Value.ToString() != null)
                                    {
                                        if (dgv08001.SelectedRows[0].Cells[11].Value.ToString().Trim() != "")
                                        {
                                            cbx001002006.Text = dgv08001.SelectedRows[0].Cells[12].Value.ToString();
                                        }
                                        else
                                        {
