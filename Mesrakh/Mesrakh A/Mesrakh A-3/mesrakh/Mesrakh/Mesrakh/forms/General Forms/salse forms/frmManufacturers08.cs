...
namespace Mesrakh
{
    public partial class frmManufacturers08 : Form
    {
        ...
        {
            InitializeComponent();
            Allfrm08ElementsEventsAndProperties(true, true); // جميع عناصر النموذج
        }

        public void Allfrm08ElementsEventsAndProperties(bool Properties, bool Events = false)  //  جميع العناصر
        {
                    ...
                    try
                    {
                        ...
                        if (txt08001002001.Text == "")
                        {
                            ...
                            if (Error == "")
                            {
                                ...
                                object ManufacturerNo = DataTools.DataBases.Run(ref result00, "spAddManufacturers", CommandType.Text, new object[][] { new object[] { "@CompanyNameAr", txt08001002002.Text }, new object[] { "@CompanyNameEn", txt08001002003.Text }, new object[] { "@ConnectingMethodsOfCommunicationNO", ConnectingMethodsOfCommunicationNO }, new object[] { "@ManufacturerNo", "OUT" } });
                               ...
                               if(result00[1] == "succeeded")
                                {
                                    ...
                                    Allfrm08ElementsEventsAndProperties(true); // تم تحديث جميع الخصائص لتعود الازرار لوضعها الطبيعي

                                    // تحديث بيانات جدول المنتجات 
                                    if (GeneralVariables._frmProducts09 != null) GeneralVariables._frmProducts09 = null;
                                }
                        ...
                        else
                        {
                            ...
                            if (Error == "")
                            {
                                ...
                                if (result00[1] == "succeeded")
                                {
                                    ...
                                    Allfrm08ElementsEventsAndProperties(true);
