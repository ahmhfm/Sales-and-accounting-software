...
namespace Mesrakh
{
    public partial class frmSalseInvoice : Form
    {
        ...
        public string ClientsName = ""; // إسم العميل
            ...
            else if (Properties == true && Events == true)
            {
                ...
                btn001.Click += delegate
                {
                    ...
                    if (result[1] == "succeeded")
                    {
                        ...
                        frm.SalesCartNo = SalesCartNo;// رقم سلة المشتريات
                        frm.ShiftNumber = ShiftNumber; // رقم الوردية
                        frm.ClientsNo = ClientsNo; // رقم العميل
                        frm.txt000.Text = SalesInvoiceNumber.ToString(); // رقم فاتورة البيع
                        frm.Font = this.Font;
                        frm.txt001.Text = ClientsNo;
                        frm.txt002.Text = ClientsName;
                        frm.txt003.Text = txt002.Text;
                        frm.txt004.Text = "0";
                        frm.txt005.Text = "0";
                        frm.txt006.Text = "0";
                        frm.ShowDialog();
