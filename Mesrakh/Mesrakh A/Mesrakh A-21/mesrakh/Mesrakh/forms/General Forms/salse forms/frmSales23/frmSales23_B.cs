                ...
                btn004.Click += delegate
                {
                    if(lbl0010.Text.Trim() == "")
                    {
                        if(dgv001.Rows.Count > 0)
                        {
                            ...
                            if((this.Parent.Parent.Parent.Parent.Parent as frmSales23).TblOpenShiftsForThisOperationUnit != null)
                            {
                                ...
                                frm.ClientsNo = lbl003.Text; // رقم العميل
                                frm.ClientsName = lbl0033.Text; // اسم العميل
                            ...
                            {
                                (this.Parent.Parent.Parent.Parent.Parent as frmSales23).Close();//0543202334
                            }
                        }
                        else
                        {
