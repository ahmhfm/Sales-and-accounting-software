...
public class Cultures
{
    ...
    public static void fillTranslationTable()
    {
        if (tblTranslation is null)
        {
            ...
            tblTranslation.Rows.Add(new string[] { "531", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "532", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "533", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "534", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "535", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "536", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "537", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "538", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "539", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "540", "", "", "" });
        }
    }
