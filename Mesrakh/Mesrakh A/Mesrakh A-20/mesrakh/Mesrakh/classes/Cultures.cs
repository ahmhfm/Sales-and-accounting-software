...
public class Cultures
{
    ...
    public static void fillTranslationTable()
    {
        if (tblTranslation is null)
        {
            ...
            tblTranslation.Rows.Add(new string[] { "432", "", "", "" });
            ...
            tblTranslation.Rows.Add(new string[] { "516", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "517", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "518", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "519", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "520", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "521", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "522", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "523", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "524", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "525", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "526", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "527", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "528", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "529", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "530", "", "", "" });
