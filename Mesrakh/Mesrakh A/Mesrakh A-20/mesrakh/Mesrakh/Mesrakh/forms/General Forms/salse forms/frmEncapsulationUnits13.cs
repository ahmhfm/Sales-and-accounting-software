...
namespace Mesrakh
{
    public partial class frmEncapsulationUnits13 : Form
    {
        ...
        {
            InitializeComponent();
            AllfrmEncapsulationUnits13ElementsEventsAndProperties(true, true); // جميع عناصر النموذج
        }

        public void AllfrmEncapsulationUnits13ElementsEventsAndProperties(bool Properties, bool Events = false)  //  جميع العناصر
        {
                        ...
                        if (txt08001002001.Text == "")
                        {
                            ...
                            if (Error == "")
                            {
                                ...
                                if(result[1] == "succeeded")
                                {
                                    ...
                                    AllfrmEncapsulationUnits13ElementsEventsAndProperties(true); // تم تحديث جميع الخصائص لتعود الازرار لوضعها الطبيعي
                                }
                        ...
                        else
                        {
                            ...
                            if (Error == "")
                            {
                                ...
                                if (result[1] == "succeeded")
                                {
                                    ...
                                    AllfrmEncapsulationUnits13ElementsEventsAndProperties(true);
                                }
