...
namespace Mesrakh
{
    public partial class frmAccounts11 : Form
    {
        public frmAccounts11()
        {
            ...
            InitializeComponent();
            AllfrmAccounts11ElementsEventsAndProperties(true, true); // جميع عناصر النموذج
        }

        public void AllfrmAccounts11ElementsEventsAndProperties(bool Properties, bool Events = false)  //  جميع العناصر
        {
