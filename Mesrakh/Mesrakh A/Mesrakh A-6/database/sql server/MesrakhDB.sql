...
--select TblSubJournalEntry.SubJornalEntryNo,TblAccounts.AccountNo ,TblAccounts.AccountNameAR,TblAccounts.AccountNameEN,TblSubJournalEntry.DebitValue,TblSubJournalEntry.CreditValue, TblSubJournalEntry.AccountingEntrytStatement from TblSubJournalEntry inner join TblAccounts on TblAccounts.AccountNo = TblSubJournalEntry.AccountNo where TblSubJournalEntry.AccountNo = 1
