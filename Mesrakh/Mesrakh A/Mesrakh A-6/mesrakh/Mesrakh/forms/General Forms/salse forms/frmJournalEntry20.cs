...
namespace Mesrakh
{
    public partial class frmJournalEntry20 : Form
    {
        ...
        private void txtDebitValueEventsAndProperties(bool Properties = true, bool Events = false) // مربع نص مدين
        {
            ...
            if (Properties == true && Events == false)
            {
                ElementsTools.TextBox_.CustumProperties(txtDebitValue, cultureInfo, ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1, true, false, TextBoxType.Decimal);
            }
            else if (Properties == true && Events == true)
            {
                ElementsTools.TextBox_.CustumProperties(txtDebitValue, cultureInfo, ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1, true, true,TextBoxType.Decimal);
        ...
        private void txtCreditValueEventsAndProperties(bool Properties = true, bool Events = false) // مربع نص دائن
        {
            ...
            if (Properties == true && Events == false)
            {
                ElementsTools.TextBox_.CustumProperties(txtCreditValue, cultureInfo, ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1, true, false, TextBoxType.Decimal);
            }
            else if (Properties == true && Events == true)
            {
                ElementsTools.TextBox_.CustumProperties(txtCreditValue, cultureInfo, ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1, true, true, TextBoxType.Decimal);
        ...
        private void txtAccountingEntrytStatementEventsAndProperties(bool Properties = true, bool Events = false) // مربع نص التفاصيل
        {
            ...
            if (Properties == true && Events == false)
            {
                ElementsTools.TextBox_.CustumProperties(txtAccountingEntrytStatement, cultureInfo);
            }
            else if (Properties == true && Events == true)
            {
                ElementsTools.TextBox_.CustumProperties(txtAccountingEntrytStatement, cultureInfo, ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1, true, true);
