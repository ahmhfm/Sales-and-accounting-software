...
namespace Mesrakh
{
    public partial class frmClients19 : Form
    {
        ...
        private void txt001002006EventsAndProperties(bool Properties, bool Events = false) // مربع نص الفائدة على رأس المال
        {
            ...
            if (Properties == true && Events == false)
            {
                ElementsTools.TextBox_.CustumProperties(txt001002006, cultureInfo, ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1, true, false, TextBoxType.Decimal);
            }
            else if (Properties == true && Events == true)
            {
                ElementsTools.TextBox_.CustumProperties(txt001002006, cultureInfo, ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1, true, true, TextBoxType.Decimal);
        ...
        private void txt001002007EventsAndProperties(bool Properties, bool Events = false) // مربع نص إسم ملصق نسبة الشريك من الأرباح 
        {
            ...
            if (Properties == true && Events == false)
            {
                ElementsTools.TextBox_.CustumProperties(txt001002007, cultureInfo, ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1, true, false, TextBoxType.Decimal);
            }
            else if (Properties == true && Events == true)
            {
                ElementsTools.TextBox_.CustumProperties(txt001002007, cultureInfo, ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1, true, true,TextBoxType.Decimal);
                        ...
                        if (txt001002001.Text.Trim() == "")
                        {
                            ...
                            if (Error == "")
                            {
                                ...
                                DataTools.DataBases.Run(ref result00, "insert into TblClients values " +
                                    "(@ClientNameAR,@ClientNameEN,@Customer,@Supplier,@TaxNo,@OtherDetails,@InterestOnCapital,@PartnersShareOfProfits,@ConnectingMethodsOfCommunicationNO)", CommandType.Text, new object[][] { 
                        ...
                        else
                        {
                            ...
                            if (Error == "")
                            {
                                ...
                                DataTools.DataBases.Run(ref result00, "update TblClients set " +
                                    " ClientNameAR = @ClientNameAR,ClientNameEN = @ClientNameEN, Customer = @Customer,Supplier = @Supplier,TaxNo = @TaxNo,OtherDetails = @OtherDetails,InterestOnCapital = @InterestOnCapital,PartnersShareOfProfits = @PartnersShareOfProfits where ClientsNo = @ClientsNo ", CommandType.Text, new object[][] {
                                    new object[] { "@ClientNameAR", txt001002002.Text },
                                    new object[] { "@ClientNameEN", txt001002003.Text },
                                    new object[] { "@Customer", cbCustomer.Checked },
                                    new object[] { "@Supplier", cbSupplier.Checked },
