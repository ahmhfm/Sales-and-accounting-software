...
namespace Mesrakh
{
    public partial class frmCountries17 : Form
    {
        ...
        private void txt001002001EventsAndProperties(bool Properties, bool Events = false) // مربع نص رقم الدولة
        {
            if (Properties == true & Events == false)
            {
                ElementsTools.TextBox_.CustumProperties(txt001002001);
            }
            else if (Properties == true & Events == true)
            {
                ElementsTools.TextBox_.CustumProperties(txt001002001, "", ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1, true, true);
            }
        }
        ...
        private void txt001002002EventsAndProperties(bool Properties = true, bool Events = false) // مربع نص إسم الدولة عربي
        {
            ...
            if (Properties == true && Events == false)
            {
                ElementsTools.TextBox_.CustumProperties(txt001002002, cultureInfo);
            }
            else if (Properties == true && Events == true)
            {
                ElementsTools.TextBox_.CustumProperties(txt001002002, cultureInfo, ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1, true, true);
        ...
        private void txt001002003EventsAndProperties(bool Properties, bool Events = false) // مربع نص إسم الدولة إنجليزي
        {
            ...
            if (Properties == true && Events == false)
            {
                ElementsTools.TextBox_.CustumProperties(txt001002003, cultureInfo);
            }
            else if (Properties == true && Events == true)
            {
                ElementsTools.TextBox_.CustumProperties(txt001002003, cultureInfo, ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1, true, true);
        ...
        private void txt001002004EventsAndProperties(bool Properties, bool Events = false) // مربع نص الجنسية للذكور عربي
        {
            ...
            if (Properties == true && Events == false)
            {
                ElementsTools.TextBox_.CustumProperties(txt001002004, cultureInfo);
            }
            else if (Properties == true && Events == true)
            {
                ElementsTools.TextBox_.CustumProperties(txt001002004, cultureInfo, ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1, true, true);
        ...
        private void txt001002005EventsAndProperties(bool Properties, bool Events = false) // مربع نص الجنسية للذكور إنجليزي
        {
            ...
            if (Properties == true && Events == false)
            {
                ElementsTools.TextBox_.CustumProperties(txt001002005, cultureInfo);
            }
            else if (Properties == true && Events == true)
            {
                ElementsTools.TextBox_.CustumProperties(txt001002005, cultureInfo, ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1, true, true);
        ...
        private void txt001002006EventsAndProperties(bool Properties, bool Events = false) // مربع نص الجنسية للاناث عربي
        {
            if (Properties == true & Events == false)
            {
                ElementsTools.TextBox_.CustumProperties(txt001002006,"ar-SA");
            }
            else if (Properties == true & Events == true)
            {
                ElementsTools.TextBox_.CustumProperties(txt001002006, "", ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1, true, true);
        ...
        private void txt001002007EventsAndProperties(bool Properties = true, bool Events = false) // مربع نص الجنسية للاناث إنجليزي
        {
            ...
            if (Properties == true && Events == false)
            {
                ElementsTools.TextBox_.CustumProperties(txt001002007, cultureInfo);
            }
            else if (Properties == true && Events == true)
            {
                ElementsTools.TextBox_.CustumProperties(txt001002007, cultureInfo, ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1, true, true);
        ...
        private void txt001002008EventsAndProperties(bool Properties, bool Events = false) // مربع نص إسم العملة عربي
        {
            ...
            if (Properties == true && Events == false)
            {
                ElementsTools.TextBox_.CustumProperties(txt001002008, cultureInfo);
            }
            else if (Properties == true && Events == true)
            {
                ElementsTools.TextBox_.CustumProperties(txt001002008, cultureInfo, ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1, true, true);
        ...
        private void txt001002009EventsAndProperties(bool Properties, bool Events = false) // مربع نص إسم العملة إنجليزي
        {
            ...
            if (Properties == true && Events == false)
            {
                ElementsTools.TextBox_.CustumProperties(txt001002009, cultureInfo);
            }
            else if (Properties == true && Events == true)
            {
                ElementsTools.TextBox_.CustumProperties(txt001002009, cultureInfo, ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1, true, true);
        ...
        private void txt001002010EventsAndProperties(bool Properties, bool Events = false) // مربع نص القيمة مقابل الدولار
        {
            ...
            if (Properties == true && Events == false)
            {
                ElementsTools.TextBox_.CustumProperties(txt001002010, cultureInfo, ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1, true, false,TextBoxType.Decimal);
            }
            else if (Properties == true && Events == true)
            {
                ElementsTools.TextBox_.CustumProperties(txt001002010, cultureInfo, ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1, true, true, TextBoxType.Decimal);
