...
public class Cultures
{
    ...
    public static void fillTranslationTable()
    {
        if (tblTranslation is null)
        {
            ...
            tblTranslation.Rows.Add(new string[] { "383", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "384", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "385", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "386", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "387", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "388", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "389", "", "", "" });
