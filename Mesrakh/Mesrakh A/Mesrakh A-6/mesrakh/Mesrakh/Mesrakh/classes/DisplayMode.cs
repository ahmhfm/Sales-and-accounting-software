...
class DisplayMode
{
    ...
    public static void fillTblColors()
    {
        if (tblColors is null)
        {
            ...
            tblColors.Rows.Add(new string[] { "00,00,00", "00,00,00", myElementType.Label.ToString(), ColorPropertyName.BackColor_4.ToString() });  // 
            ...
            tblColors.Rows.Add(new string[] { "40,40,40", "93, 152, 233", myElementType.Label.ToString(), ColorPropertyName.ForeColor_4.ToString() });        // 
            tblColors.Rows.Add(new string[] { "00, 00, 00", "00,00,00", myElementType.Label.ToString(), ColorPropertyName.ForeColor_5.ToString() });        // 
            ...
            //  TabControl 
            tblColors.Rows.Add(new string[] { "60, 60, 60", "227, 241, 251", myElementType.TabControl.ToString(), ColorPropertyName.BackColor_1.ToString() }); //   
            ...
            tblColors.Rows.Add(new string[] { "0,0,0", "22,144,222", myElementType.DataGridView.ToString(), ColorPropertyName.GridColor_1.ToString() });  // 
    ...
    public static void fillTblFontAndLocation()
    {
        try
        {
            ...
            if (tblFontAndLocation is null)
            {
                ...
                tblFontAndLocation.Rows.Add(new string[] { "9", "frmProducts09", "Microsoft Sans Serif", "5", "1000", "1000" });  // 
                ...
                tblFontAndLocation.Rows.Add(new string[] { "14", "", "Microsoft Sans Serif", "5", "1000", "1000" });  // 
                tblFontAndLocation.Rows.Add(new string[] { "15", "", "Microsoft Sans Serif", "5", "1000", "1000" });  // 
                tblFontAndLocation.Rows.Add(new string[] { "16", "", "Microsoft Sans Serif", "5", "1000", "1000" });  // 
                tblFontAndLocation.Rows.Add(new string[] { "17", "", "Microsoft Sans Serif", "5", "1000", "1000" });  // 
                tblFontAndLocation.Rows.Add(new string[] { "18", "", "Microsoft Sans Serif", "5", "1000", "1000" });  // 
                tblFontAndLocation.Rows.Add(new string[] { "19", "", "Microsoft Sans Serif", "5", "1000", "1000" });  // 
                tblFontAndLocation.Rows.Add(new string[] { "20", "", "Microsoft Sans Serif", "5", "1000", "1000" });  // 
