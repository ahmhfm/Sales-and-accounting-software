...
add constraint PK_TblBatch_TblProductsAndServices_productOrServiceNumber foreign key (productOrServiceNumber) references TblProductsAndServices(productOrServiceNumber)  ;
...
Create table TblCoins
(
CurrencyNo int primary key identity(1,1),        -- رقم العملة
CoinNameAR varchar(50),          -- اسم العملة عربي
CoinNameEN varchar(50),          -- اسم العملة النجليزي
CurrencySymbolAR varchar(20),     -- رمز العملة عربي
CurrencySymbolEN varchar(20),     -- رمز العملة انجليزي
ValueAgainstDollar decimal(8,2)  -- قيمة العملة مقابل الدولار
)

GO
--insert into TblCoins values ('ريال','rial','رس','rs',3.75);
--insert into TblCoins values ('دولار امريكي','dolar us','د أ','dus',1);
--GO
----*  214  *----------( الدول )---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------  
...
CountryNameAR  varchar(50),            -- اسم الدولة عربي
CountryNameEN varchar(50) ,            -- اسم الدولة انجليزي
CurrencyNo int ,                        -- رقم العملة 
MaleNationalityNameAR varchar(20),           -- مسمى الجنسية للذكور عربي
FemaleNationalityNameAR varchar(20) ,         --  مسمى الجنسية للاناث عربي
NationalityNameEN varchar(20)           -- مسمى الجنسيةانجليزي

)

GO

-- ( ربط حقل رقم العملة  بحقل رقم العملة في جدول العملات  )

alter table TblCountries
add constraint PK_TblCountries_TblCoins_CurrencyNo foreign key (CurrencyNo) references TblCoins(CurrencyNo)  ;

GO
--insert into TblCountries values ('المملكة العربية السعودية','saudi arabia',1,'سعودي','سعودية','Saudi');
--insert into TblCountries values ('الولايات المتحدة الامريكية','united statse',2,'امريكي','امريكية','American');

--GO
----*  215  *----------( المناطق والولايات )---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------  

create table TblRegionOrStateNo
(
RegionOrStateNo int primary key identity(1,1),           -- رقم المنطقة او الولاية
RegionOrStateNoNameAR  varchar(50),            -- اسم المنطقة او الولاية عربي
RegionOrStateNoNameEN varchar(50) ,            -- اسم المنطقة او الولاية انجليزي
CountryNo int                         -- رقم الدولة 
)

GO

-- ( ربط حقل رقم الدولة  بحقل رقم رقم الدولة في جدول الدول  )

alter table TblRegionOrStateNo
add constraint PK_TblRegionOrStateNo_TblCountries_CountryNo foreign key (CountryNo) references TblCountries(CountryNo)  ;

GO
--insert into TblRegionOrStateNo values ('الرياض','riad',1)
--insert into TblRegionOrStateNo values ('جدة','jeddah',1)

--GO
----*  216  *----------( المحافظات والمدن  )---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------  

create table TblCityOrProvince
(
CityOrProvinceNo int primary key identity(1,1),           -- رقم المحافظة او المدينة
CityOrProvinceNameAR  varchar(50),            -- اسم المحافظة او المدينة عربي
CityOrProvinceNameEN varchar(50) ,            -- اسم المحافظة او المدينة انجليزي
RegionOrStateNo int                           -- رقم المنطقة او الولاية 
)

GO

-- ( ربط حقل رقم المنطقة او الولاية  بحقل رقم رقم المنطقة او الولاية في جدول المناطق والولايات  )

alter table TblCityOrProvince
add constraint PK_TblCityOrProvince_TblRegionOrStateNo_RegionOrStateNo foreign key (RegionOrStateNo) references TblRegionOrStateNo(RegionOrStateNo)  ;

GO
--insert into TblCityOrProvince values ('وادي الدواس','al wadi',1);
--insert into TblCityOrProvince values ('الافلاج','al aflaje',1);
...
(
AddressNo int primary key identity(1,1),           -- رقم العنوان
CountryNo  int,                              -- الدولة
RegionOrStateNo int ,                    -- المنطقة او الولاية
CityOrProvinceNo int ,                   -- المدينة او المحافظة
VillageOrNeighborhood varchar(50) ,       -- القرية او الحي السكني
PoBoxNo varchar(10) ,                     -- رقم صندوق البريد
ZipCode varchar(10)                            -- الرمز البريدي
)

GO

-- ( ربط حقل  الدولة  بحقل رقم رقم الدولة في جدول الدول  )

alter table TblAddresses
add constraint PK_TblAddresses_TblCountries_CountryNo foreign key (CountryNo) references TblCountries(CountryNo)  ;

GO


-- ( ربط حقل المنطقة او الولاية  بحقل رقم رقم المنطقة او الولاية في جدول المناطق والولايات  )

alter table TblAddresses
add constraint PK_TblAddresses_TblRegionOrStateNo_RegionOrStateNo foreign key (RegionOrStateNo) references TblRegionOrStateNo(RegionOrStateNo)  ;

GO

-- ( ربط حقل رقم المدينة او المحافظة  بحقل رقم المدينة او المحافظة في جدول المدن او المحافظات   )

alter table TblAddresses
add constraint PK_TblAddresses_TblCityOrProvince_CityOrProvinceNo foreign key (CityOrProvinceNo) references TblCityOrProvince(CityOrProvinceNo)  ;

GO
--insert into TblAddresses values (1,1,1,'البلد','boxNo654','Mail665'); 
--insert into TblAddresses values (1,1,1,'الديرة','boxNo11','Mail11'); 
--insert into TblAddresses values (1,1,1,'الوادي','boxNo22','Mail22'); 
--GO
----*  218  *----------( أنواع الفروع )---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------  

create table TblBranchesTypes
(
BranchTypeNo int primary key identity(1,1),   -- رقم نوع الفرع
BranchTypeNameAR varchar(200),    -- نوع الفرع عربي
BranchTypeNameEN varchar(200)     -- نوع الفرع انجليزي
)

GO
insert into TblBranchesTypes values ('مستودع','store');
insert into TblBranchesTypes values ('معرض','Exhibition');
GO
----*  219  *----------( المنشآت )---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------  
...
-- ( ربط حقل رقم نوع الفرع  بحقل رقم نوع الفرع في جدول انواع الفروع   )
alter table TblEnterpriseBranches
add constraint PK_TblEnterpriseBranches_TblBranchesTypes_BranchTypeNo foreign key (BranchTypeNo) references TblBranchesTypes(BranchTypeNo)  ;

GO

-- ( ربط حقل رقم العنوان  بحقل رقم العنوان في جدول العناوين   )
alter table TblEnterpriseBranches
add constraint PK_TblEnterpriseBranches_TblAddresses_AddressNo foreign key (AddressNo) references TblAddresses(AddressNo)  ;
...
--GO
----*  222  *----------( الرفوف والمنتجات )---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------  

create table TblshevesAndProducts
(
ConnectNo int primary key identity(1,1),             -- رقم الربط
productOrServiceNumber int,                  -- رقم السلعة او الخدمة 
...
-- ( ربط حقل رقم السلعة او الخدمة  بحقل رقم السلعة او الخدمة في جدول الخدمات والسلع    )
alter table TblshevesAndProducts
add constraint PK_TblshevesAndProducts_TblProductsAndServices_productOrServiceNumber foreign key (productOrServiceNumber) references TblProductsAndServices(productOrServiceNumber)  ;

GO

-- ( ربط حقل الرقم العام للرف  بحقل الرقم العام للرف في جدول الرفوف    )
alter table TblshevesAndProducts
add constraint PK_TblshevesAndProducts_TblShelves_ShelfGeneralNo foreign key (ShelfGeneralNo) references TblShelves(ShelfGeneralNo)  ;

GO
--insert into TblshevesAndProducts values (3,1);
--insert into TblshevesAndProducts values (3,4);
--insert into TblshevesAndProducts values (4,5);
--insert into TblshevesAndProducts values (5,6);
--GO

----*  223  *----------( الوكلاء )---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------  
create table TblAgents
(
AgencyNo int primary key identity(1,1), -- رقم الوكالة
AgencyNameAR varchar(200),              -- اسم الوكالة عربي
AgencyNameEN varchar(200),              -- اسم الوكالة انجليزي
ConnectingMethodsOfCommunicationNO int  -- رقم ربط طرق الاتصال
)
GO

-- ( ربط حقل رقم ربط او تحزيم طرق الاتصال بجدول ربط او تحزيم طرق الاتصال   )
alter table TblAgents
add constraint PK2_TblAgents_TblConnectingMethodsOfCommunication_ConnectingMethodsOfCommunicationNO foreign key (ConnectingMethodsOfCommunicationNO) references TblConnectingMethodsOfCommunication(ConnectingMethodsOfCommunicationNO)  ;

GO
--insert into TblAgents values ('وكالة1','agent1',1);
--insert into TblAgents values ('وكالة2','agent2',1);
--GO
----*  224  *----------( الشركات والوكالات التجارية )---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------  

create table TblCompaniesAgents
(
CompanyAgentNo int primary key identity(1,1),
ManufacturerNo int ,
AgentNo int,
...
GO
-- ( ربط حقل رقم الشركة  بحقل رقم الشركة في جدول الشركات    )

alter table TblCompaniesAgents
add constraint pk_TblCompaniesAgents_TblManufacturers_ManufacturerNo foreign key (ManufacturerNo) references TblManufacturers(ManufacturerNo)

GO

-- ( ربط حقل رقم الوكيل  بحقل رقم الوكيل في جدول الوكلاء    )

alter table TblCompaniesAgents
add constraint pk_TblCompaniesAgents_TblAgents_AgencyNo foreign key (AgentNo) references TblAgents(AgencyNo)

GO
--insert into TblCompaniesAgents values (1,1,'2000/1/1','2009/1/1');
--insert into TblCompaniesAgents values (1,2,'2009/1/1','2031/1/1');
--GO
----*  225  *----------( عناوين الوكلاء )---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------  

create table TblAgentsAddresses
(
AgentAddressNo int primary key identity(1,1),  -- رقم عنوان الوكيل
AgencyNo int,                      -- رقم الوكالة
AddressNo int                      -- رقم العنوان
)
...
alter table TblAgentsAddresses
add constraint pk_TblAgentsAddresses_TblAgents_AgencyNo foreign key (AgencyNo) references TblAgents(AgencyNo)
...
alter table TblAgentsAddresses
add constraint pk_TblAgentsAddresses_TblAddresses_AddressNo foreign key (AddressNo) references TblAddresses(AddressNo)

GO
--insert into TblAgentsAddresses values (1,1);
--GO
----*  226  *----------( انواع العملاء )---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------  

create table TblClientstypes
(
ClientsTypesNo int primary key identity(1,1),  -- رقم نوع العميل
ClientTypeAR varchar(50),          -- نوع العميل عربي
ClientTypeEN varchar(50)           -- نوع العميل انجليزي
)

GO
insert into TblClientstypes values ('مورد','soplayer');
insert into TblClientstypes values ('زبون','castomer');
insert into TblClientstypes values ('شريك','partner');
insert into TblClientstypes values ('موظف','employee');
GO
----*  227  *----------( العملاء )---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------  
...
GO
-- ( ربط حقل نوع العميل  بحقل رقم نوع العميل في جدول انواع العملاء    )
alter table TblClients
add constraint pk_TblClients_TblClientstypes_ClientsTypesNo foreign key (ClientsTypesNo) references TblClientstypes(ClientsTypesNo)
...
(
ClientAddressesNo int primary key identity(1,1),  -- رقم عنوان العميل
...
-- ( ربط حقل رقم العميل  بحقل رقم رقم العميل في جدول العملاء    )

alter table TblClientAddresses
add constraint pk_TblClientAddresses_TblClients_ClientsNo foreign key (ClientsNo) references TblClients(ClientsNo)
...
alter table TblClientAddresses
add constraint pk_TblClientAddresses_TblAddresses_AddressNo foreign key (AddressNo) references TblAddresses(AddressNo)

GO
--insert into TblClientAddresses values (1,1);
--insert into TblClientAddresses values (1,2);
--insert into TblClientAddresses values (1,3);
--GO
...
Employeesimage varchar(max) ,           -- الصورة
ConnectingMethodsOfCommunicationNO int -- رقم تحزيم طرق الاتصال
)

GO
--(ربط حقل رقم الجنسية بجدول الدول)
...
create table TblIdentitiesTypes
(
IdentitiesTypeNo int primary key identity(1,1),
IdentitiesTypeAR varchar(50),
IdentitiesTypeEN varchar(50)
)

GO
insert into TblIdentitiesTypes values ('بطاقة أحوال','ID Card');
insert into TblIdentitiesTypes values ('جواز','passport');
insert into TblIdentitiesTypes values ('إقامة','Residence Card');
GO
----*  231  *----------(   ربط الموظف والهوية )---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------  

create table TblEmployeeAndIdentity
(
EmployeeAndIdentityNo int primary key identity(1,1),  -- الرقم الفرعي
IdentitiesTypeNo int,                     -- رقم نوع الهوية
IdentitiesNo varchar(20),                 -- رقم الهوية
IdExpirationDate datetime,                -- تاريخ انتهاءالهوية
EmployeeNo int                            -- رقم الموظف
)

GO

-- ( ربط حقل رقم نوع الهوية  بحقل رقم نوع الهوية في جدول انواع الهويات    )

alter table TblEmployeeAndIdentity
add constraint pk_TblEmployeeAndIdentity_TblIdentitiesTypes_IdentitiesTypeNo foreign key (IdentitiesTypeNo) references TblIdentitiesTypes(IdentitiesTypeNo)
...
alter table TblEmployeeAndIdentity
add constraint pk_TblEmployeeAndIdentity_TblEmployees_EmployeeNo foreign key (EmployeeNo) references TblEmployees(EmployeeNo)

GO
--insert into TblEmployeeAndIdentity values (1,'208896879969','2025/1/1',1);
--insert into TblEmployeeAndIdentity values (2,'145454','2022/1/1',2);
--insert into TblEmployeeAndIdentity values (1,'5458987777','2029/1/1',2);

--GO
----*  232  *----------( عناوين الموظفين )---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------  

create table TblEmployeeAddresses
(
EmployeeAddressNo int primary key identity(1,1),  -- رقم عنوان الموظف
EmployeeNo int,                       -- رقم الموظف
AddressNo int                         -- رقم العنوان
)
...
-- ( ربط حقل رقم الموظف  بحقل رقم رقم الموظف في جدول الموظفين    )

alter table TblEmployeeAddresses
add constraint pk_TblEmployeeAddresses_TblEmployees_EmployeeNo foreign key (EmployeeNo) references TblEmployees(EmployeeNo)
...
alter table TblEmployeeAddresses
add constraint pk2_TblEmployeeAddresses_TblAddresses_AddressNo foreign key (AddressNo) references TblAddresses(AddressNo)

GO
--insert into TblEmployeeAddresses values (1,1);
--insert into TblEmployeeAddresses values (2,2);
--GO
----*  233  *----------( مسميات الوظائف )---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------  

create table TblJobTitles
(
JobNameNumber int primary key identity(1,1),  -- رقم اسم الوظفية
JobNameAR varchar(100),           -- اسم الوظيفة عربي
JobNameEN varchar(100),           -- اسم الوظفين انجليزي
JobDescription varchar(500),      -- وصف الوظيفة
JobDuties varchar(500)            -- مهام الوظيفة
)

GO
--insert into TblJobTitles values ('مدير فرع','مدير فرع انجليزي','ادارة المبيعات والموظفين ','استلام الفرع و استلام الفلوس واستلام البضائع');
--insert into TblJobTitles values ('موظف مبيعات','موظف مبيعات انجليزي',' المبيعات',' استلام الفلوس واستلام البضائع');

--GO
----*  234  *----------(  الموظفين والفروع )---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------  

create table TblBranchesAndEmployees
(
AppointmentDecisionNo int primary key identity(1,1), -- رقم قرار التعيين
EmployeeNo int,                          -- رقم الموظف
BranchNumber int ,                       -- رقم الفرع
WorkStartingDate datetime,               -- تاريخ بداية العمل في الفرع
WorkEndDate datetime ,                   -- تاريخ نهاية العمل في الفرع
JobNameNumber int                        -- رقم اسم الوظيفة
)
...
alter table TblBranchesAndEmployees
add constraint pk_TblBranchesAndEmployees_TblEmployees_EmployeeNo foreign key (EmployeeNo) references TblEmployees(EmployeeNo)

GO

-- ( ربط حقل رقم الفرع  بحقل رقم الفرع في جدول الموظفين    )

alter table TblBranchesAndEmployees
add constraint pk_TblBranchesAndEmployees_TblEnterpriseBranches_BranchNumber foreign key (BranchNumber) references TblEnterpriseBranches(BranchNumber)

GO

-- ( ربط حقل رقم اسم الوظيفة  بحقل رقم اسم الوظيفة في جدول مسميات الوظائف    )

alter table TblBranchesAndEmployees
add constraint pk_TblBranchesAndEmployees_TblJobTitles_JobNameNumber foreign key (JobNameNumber) references TblJobTitles(JobNameNumber)

GO
--insert into TblBranchesAndEmployees values (1,1,'2000/1/4','2030/1/1',1);
--insert into TblBranchesAndEmployees values (2,1,'2000/1/4','2030/1/1',2);
--GO
...
(
PermissionGroupNo int primary key identity(1,1),  -- رقم البرنامج
...
----*  210  *----------( اجراء مخزن لانشاء حساب جديد )---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------  
...
------*  254  *----------( انواع عمليات الجرد )---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------  

create table TblInventoryType
(
TypeNo int primary key identity(1,1),   -- رقم النوع
TypeArabic varchar(100),    -- النوع بالعربي
TypeEnglish varchar(100)    -- النوع بالانجليزي
)
...
create table TblInventoryOperations
(
InventoryOperationNo int primary key identity(1,1),  -- رقم عملية الجرد
OperationNo int,                         -- رقم العملية
TypeNo int,                              -- رقم النوع
FiscalYear varchar(50),                  -- السنة المالية
Total decimal(9,2)                       -- الاجمالي الكلي
)
...
alter table TblInventoryOperations
add constraint pk_TblInventoryOperations_TblOperations_OperationNo   foreign key (OperationNo) references TblOperations(OperationNo) 

GO

--(ربط حقل رقم النوع بحقل رقم النوع في جدول انواع عمليات الجرد)

alter table TblInventoryOperations
add constraint pk_TblInventoryOperations_TblInventoryType_TypeNo foreign key (TypeNo) references TblInventoryType(TypeNo)
GO
------*  256  *----------( تفاصيل عمليات الجرد )---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------  

create table TblInventoryOperationDetails
(
InventoryOperationDetailsNo int primary key identity(1,1),  -- رقم تفصيل عملية الجرد
InventoryOperationNo int,                         -- رقم عملية الجرد
productOrServiceNumber int,                      -- رقم السلعة او الخدمة
UnitDetailsNo int ,               -- رقم تفاصيل الوحدة
BatchNo int,                                    -- التشغيلة
ShelfGeneralNo int,                             -- الرقم العام للرف
RecordsStock decimal(9,2),                      -- الرصيد القيدي
ActualStock decimal(9,2),                       -- الرصيد الفعلي
UnitCost decimal(9,2),                          -- تكلفة شراء الوحدة
SubTotal  decimal(9,2)                         -- الاجمالي الفرعي
)

-- ( ربط حقل رقم عملية الجرد  بحقل رقم عملية الجرد في جدول عمليات الجرد )

alter table TblInventoryOperationDetails
add constraint pk_TblInventoryOperationDetails_TblInventoryOperations_InventoryOperationNo foreign key (InventoryOperationNo) references TblInventoryOperations(InventoryOperationNo)

GO

-- ( ربط حقل رقم السلعة او الخدمة  بحقل رقم السلعة او الخدمة في جدول الخدمات والسلع    )
alter table TblInventoryOperationDetails
add constraint PK_TblInventoryOperationDetails_TblProductsAndServices_productOrServiceNumber foreign key (productOrServiceNumber) references TblProductsAndServices(productOrServiceNumber)  ;
...
alter table TblInventoryOperationDetails
add constraint pk_TblInventoryOperationDetails_TblBatch_BatchNo foreign key (BatchNo) references TblBatch(BatchNo)
...
alter table TblInventoryOperationDetails
add constraint pk_TblInventoryOperationDetails_TblShelves_ShelfGeneralNo foreign key (ShelfGeneralNo) references TblShelves(ShelfGeneralNo)

GO

-- ( ربط حقل رقم تفاصيل الوحدة  بحقل رقم تفاصيل الوحدة في جدول تفاصيل السلع والخدمات  ) 
alter table TblInventoryOperationDetails
add constraint PK2_TblInventoryOperationDetails_TblproductAndServicesDetails_UnitDetailsNo foreign key (UnitDetailsNo) references TblproductAndServicesDetails(UnitDetailsNo) on delete cascade ;
