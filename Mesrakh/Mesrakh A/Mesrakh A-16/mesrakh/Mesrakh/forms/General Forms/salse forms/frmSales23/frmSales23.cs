...
namespace Mesrakh
{
    public partial class frmSales23 : Form
    {
        ...
        public void AllEventsAndProperties(bool Properties, bool Events = false)  //  جميع العناصر
        {
            ...
            pic001EventsAndProperties(Properties, Events); // زر اضافة سلة مبيعات
        ...
        private void pic001EventsAndProperties(bool Properties, bool Events = false) // زر اضافة سلة مبيعات
        {
            ...
            if (Properties == true && Events == false)
            {
                try
                {
                    ...
                    {
                        pic001.Image = Images.ConvertBase64StringToImage(Images.ImagesLibrary.imgCart);
                    }
                    else
                    {
                        pic001.Image = Images.ConvertBase64StringToImage(Images.ImagesLibrary.imgCart);
