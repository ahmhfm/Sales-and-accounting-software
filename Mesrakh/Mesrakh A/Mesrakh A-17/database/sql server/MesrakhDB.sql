...
as 
begin
insert into TblSalesCartDetails (SalesCartNo , UnitDetailsNo ,ShortArabicName, ShortEnglishName, UnitSalePrice ,Quantity ,  TotalSalePrice ,Discount ,  TotalSalePriceAfterDiscount ,VATrate ,  OutputTax , TotalSellingPriceIncludingTax ) values (@SalesCartNo , @UnitDetailsNo ,@ShortArabicName, @ShortEnglishName, @UnitSalePrice ,@Quantity ,  @TotalSalePrice ,@Discount ,  @TotalSalePriceAfterDiscount ,@VATrate ,  @OutputTax , @TotalSellingPriceIncludingTax )
...
update TblSalesCartDetails set UnitSalePrice = @UnitSalePrice ,   Quantity = @Quantity ,  TotalSalePrice = @TotalSalePrice  ,Discount = @Discount ,  TotalSalePriceAfterDiscount = @TotalSalePriceAfterDiscount ,VATrate = @VATrate ,  OutputTax = @OutputTax , TotalSellingPriceIncludingTax = @TotalSellingPriceIncludingTax   where SalesCartDetailsNo = @SalesCartDetailsNo
...
ClientsNo int , -- رقم العميل
DeservedAmount int , -- المبلغ المستحق
cash int , -- كاش
Bank int , -- بنك
BankCheck int , -- شيك بنك
JournalEntryNo int , -- رقم قيد اليومية
ShiftNumber int -- رقم الوردية
)
