...
namespace Mesrakh
{
    public partial class frmCategories10 : Form
    {
        ...
        {
            filltblCategories(); // تعبئة جدول الشركات الصانعة
            InitializeComponent();
            AllfrmProductsCategories10ElementsEventsAndProperties(true, true); // جميع عناصر النموذج
        }

        public void AllfrmProductsCategories10ElementsEventsAndProperties(bool Properties, bool Events = false)  //  جميع العناصر
        {
