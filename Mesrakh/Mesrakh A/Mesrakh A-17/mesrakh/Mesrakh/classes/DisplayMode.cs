...
class DisplayMode
{
    ...
    public static void fillTblColors()
    {
        if (tblColors is null)
        {
            ...
            tblColors.Rows.Add(new string[] { "00, 00, 00", "00, 00, 00", myElementType.Label.ToString(), ColorPropertyName.BackColor_6.ToString() });  // 
    ...
    public static void fillTblFontAndLocation()
    {
        try
        {
            ...
            if (tblFontAndLocation is null)
            {
                ...
                tblFontAndLocation.Rows.Add(new string[] { "22", "frmSales23", "Microsoft Sans Serif", "5", "1000", "1000" });  // 
