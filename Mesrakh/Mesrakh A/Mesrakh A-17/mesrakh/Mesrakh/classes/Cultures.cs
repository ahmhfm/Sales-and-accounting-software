...
public class Cultures
{
    ...
    public static void fillTranslationTable()
    {
        if (tblTranslation is null)
        {
            ...
            tblTranslation.Rows.Add(new string[] { "501", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "502", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "503", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "504", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "505", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "506", "", "", "" });
        }
    }
