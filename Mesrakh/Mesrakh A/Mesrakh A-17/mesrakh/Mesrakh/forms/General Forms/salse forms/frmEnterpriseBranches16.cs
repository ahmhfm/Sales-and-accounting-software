                        ...
                        if (Permissions.AccountHavePermission(PermissionObjectes.Unit_Branch, PermissionType.Add))
                        {
                            ...
                            else
                            {
                                ...
                                if (check == "")
                                {
                                    ...
                                    string[] result = null;
                                    object x = DataTools.DataBases.Run(ref result, "insert into TblOperationUnits values (@BranchNumber,@UnitNoInBranch,null,null)", CommandType.Text, new object[][] { new object[] { "@BranchNumber", txt08001002001.Text }, new object[] { "@UnitNoInBranch", txtUnitNoInBranch.Text } });
            ...
            if (Properties == true && Events == false)
            {
                ...
                try
                {
                    ...
                    if (TblOperationUnits.Rows.Count > 0)
                    {
                        ...
                        dgvUnitBranch.Columns[4].Visible = false;
