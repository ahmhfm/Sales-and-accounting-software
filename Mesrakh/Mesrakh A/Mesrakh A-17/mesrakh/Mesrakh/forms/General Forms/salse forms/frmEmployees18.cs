...
namespace Mesrakh
{
    public partial class frmEmployees18 : Form
    {
        ...
        public void AllEventsAndProperties(bool Properties, bool Events = false)  //  جميع العناصر
        {
            ...
            lbl001002006EventsAndProperties(Properties, Events); // ملصق رقم الحساب
            txt001002004EventsAndProperties(Properties, Events); // مربع نص رقم الحساب
        ...
        private void lbl001002006EventsAndProperties(bool Properties, bool Events = false) // ملصق رقم الحساب
        {

            if (Properties == true & Events == false)
            {
                ElementsTools.Lable_.CustumProperties(lbl001002006, "رقم الحساب", ColorPropertyName.BackColor_1);
            }
            else if (Properties == true & Events == true)
            {
                ElementsTools.Lable_.CustumProperties(lbl001002006, "رقم الحساب", ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1, true, true);
            }
        }
