...
public partial class frmMessageBox : Form
{
    ...
    private void txt0501EventsAndProperties(bool Properties, bool Events = false) // مربع نص استلام القيم
    {
        ...
        {
            //ElementsTools.TextBox_.CustumProperties(txt0501, "", 300 , ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1);

        }
        else if (Properties == true & Events == true)
        {
            //ElementsTools.TextBox_.CustumProperties(txt0501, "", 300, ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1, true, true);
