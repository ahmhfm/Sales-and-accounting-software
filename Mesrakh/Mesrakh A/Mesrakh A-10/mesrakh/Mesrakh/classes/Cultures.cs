...
public class Cultures
{
    ...
    public static void fillTranslationTable()
    {
        if (tblTranslation is null)
        {
            ...
            tblTranslation.Rows.Add(new string[] { "425", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "426", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "427", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "428", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "429", "", "", "" });
