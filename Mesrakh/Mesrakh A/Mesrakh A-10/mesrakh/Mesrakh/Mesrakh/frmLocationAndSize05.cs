    ...
    */
    ...
    public static void form(Form form)
    {
        ...
        btn.Click += delegate
        {
            ...
            Application.OpenForms[0].Size = new Size(frmLocationAndSize.getSize()[0], frmLocationAndSize.getSize()[1]); // تغيير اعدادات حجم النموذج الرئيسي
            Application.OpenForms[0].Location = new Point(frmLocationAndSize.getLocation()[0], frmLocationAndSize.getLocation()[1]); // تغيير اعدادات موقع النموذج الرئيسي

            form.Size = new Size(frmLocationAndSize.getSize()[0], frmLocationAndSize.getSize()[1]); // تغيير الحجم بناء على الاعدادات الاخيرة
            form.Location = new Point(frmLocationAndSize.getLocation()[0], frmLocationAndSize.getLocation()[1]); // تغيير الموقع بناء على الاعدادات الاخيرة
        };
