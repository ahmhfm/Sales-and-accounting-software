...
public class Cultures
{
    ...
    public static void fillTranslationTable()
    {
        if (tblTranslation is null)
        {
            ...
            tblTranslation.Rows.Add(new string[] { "432", "الحسابات البنكية", "bank accounts", "" });
            tblTranslation.Rows.Add(new string[] { "433", "صناديق النقدية", "cash boxes", "" });
            ...
            tblTranslation.Rows.Add(new string[] { "445", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "446", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "447", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "448", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "449", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "450", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "451", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "452", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "453", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "454", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "455", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "456", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "457", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "458", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "459", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "460", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "461", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "462", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "463", "", "", "" });
