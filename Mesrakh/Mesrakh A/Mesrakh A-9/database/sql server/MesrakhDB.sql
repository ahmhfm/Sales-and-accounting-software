...
select * from TblConnectionTblShelvesAndTblProductsAndServices inner join  TblShelves on TblShelves.ShelfGeneralNo = TblConnectionTblShelvesAndTblProductsAndServices.ShelfGeneralNo
...
add constraint pk_TblSalesBill_TblUsersAccounts_UserAccountNo foreign key (UserAccountNo) references TblUsersAccounts(UserAccountNo)
GO
-- ( ربط حقل رقم العميل بالحقل المقابل في جدول العميلاء  )
alter table TblSalesBill
add constraint pk_TblSalesBill_TblClients_ClientsNo foreign key (ClientsNo) references TblClients(ClientsNo)
GO
...
alter table TblSalesBill
add constraint pk_TblSalesBill_TblOperationUnits_OperationUnitNumber foreign key (OperationUnitNumber) references TblOperationUnits(OperationUnitNumber)
GO


----*  253  *----------( تفاصيل فواتير المبيعات )---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------  
...
alter table TblSalesInvoiceDetails
add constraint PK_TblSalesInvoiceDetails_TblSalesBill_productOrServiceNumber foreign key (SalesInvoiceNumber) references TblSalesBill(SalesInvoiceNumber)  ;

GO

-- ( ربط حقل رقم تفصيل الوحدة بالحقل المقابل في جدول تفاصيل السلع والخدمات  )
alter table TblSalesInvoiceDetails
add constraint pk_TblSalesInvoiceDetails_TblproductAndServicesDetails_UnitDetailsNo foreign key (UnitDetailsNo) references TblproductAndServicesDetails(UnitDetailsNo)
...
-- ( ربط حقل اسم المستخدم الحقل المقابل في جدول حسابات المستخدمين  )
alter table TblSalesReturnsInvoice
add constraint pk_TblSalesReturnsInvoice_TblUsersAccounts_UserAccountNo foreign key (UserAccountNo) references TblUsersAccounts(UserAccountNo)
GO
-- ( ربط حقل رقم العميل بالحقل المقابل في جدول العميلاء  )
alter table TblSalesReturnsInvoice
...
-- ( رقط حقل رقم وحدة العمليات بالحقل المقابل في جدول وحدات العمليات  )
alter table TblSalesReturnsInvoice
add constraint pk_TblSalesReturnsInvoice_TblOperationUnits_OperationUnitNumber foreign key (OperationUnitNumber) references TblOperationUnits(OperationUnitNumber)
GO
