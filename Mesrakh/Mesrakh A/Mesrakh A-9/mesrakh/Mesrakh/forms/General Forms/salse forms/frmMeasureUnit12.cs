...
namespace Mesrakh
{
    public partial class frmMeasureUnit12 : Form
    {
        ...
        private void txt08001002002EventsAndProperties(bool Properties, bool Events = false) // مربع نص إسم الوحدة عربي
        {
            if (Properties == true & Events == false)
            {
                ElementsTools.TextBox_.CustumProperties(txt08001002002, "ar-SA",50);

            }
            else if (Properties == true & Events == true)
            {
                ElementsTools.TextBox_.CustumProperties(txt08001002002, "ar-SA",50, ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1, true, true);
        ...
        private void txt08001002003EventsAndProperties(bool Properties, bool Events = false) // مربع نص إسم الوحدة انجليزي
        {
            if (Properties == true & Events == false)
            {
                ElementsTools.TextBox_.CustumProperties(txt08001002003, "en-US",50);

            }
            else if (Properties == true & Events == true)
            {
                ElementsTools.TextBox_.CustumProperties(txt08001002003, "en-US",50, ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1, true, true);
        ...
        private void txt08001002004EventsAndProperties(bool Properties, bool Events = false) //مربع رمز الوحدة عربي
        {
            if (Properties == true & Events == false)
            {
                ElementsTools.TextBox_.CustumProperties(txt08001002004, "ar-SA",15);

            }
            else if (Properties == true & Events == true)
            {
                ElementsTools.TextBox_.CustumProperties(txt08001002004, "ar-SA",15, ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1, true, true);
        ...
        private void txt08001002005EventsAndProperties(bool Properties, bool Events = false) // مربع نص  رمز الوحدة إنجليزي
        {
            if (Properties == true & Events == false)
            {
                ElementsTools.TextBox_.CustumProperties(txt08001002005, "en-US",15);

            }
            else if (Properties == true & Events == true)
            {
                ElementsTools.TextBox_.CustumProperties(txt08001002005, "en-US",15, ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1, true, true);
        ...
        private void txt08001002006EventsAndProperties(bool Properties, bool Events = false) // مربع نص قيمة التحويل من الوحدة الأعلى
        {
            if (Properties == true & Events == false)
            {
                ElementsTools.TextBox_.CustumProperties(txt08001002006, "",9,ColorPropertyName.BackColor_1,ColorPropertyName.ForeColor_1,true,false, TextBoxType.Decimal);

            }
            else if (Properties == true & Events == true)
            {
                ElementsTools.TextBox_.CustumProperties(txt08001002006, "",9, ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1, true, true, TextBoxType.Decimal);
