...
namespace Mesrakh
{
    public partial class frmMain01 : Form
    {
        public frmMain01()
        {
            ...
            InitializeComponent();
            AllElementsEventsAndProperties(true, true); // الخصائص والاحداث لجميع العناصر
        }

        //--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------  All Elements
        public void AllElementsEventsAndProperties(bool Properties, bool Events = false)  //  جميع العناصر
        {
