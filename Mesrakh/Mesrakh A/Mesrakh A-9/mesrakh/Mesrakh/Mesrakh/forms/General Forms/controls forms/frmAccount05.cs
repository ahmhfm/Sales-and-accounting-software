...
namespace Mesrakh
{
    public partial class frmAccount05 : Form
    {
        ...
        public frmAccount05()
        {
            ...
            InitializeComponent();
            Allfrm05ElementsEventsAndProperties(true, true); // جميع عناصر النموذج
        }
        ...
        public void Allfrm05ElementsEventsAndProperties(bool Properties, bool Events = false)  //  جميع العناصر
        {
        ...
        private void txt05002002EventsAndProperties(bool Properties, bool Events = false) // مربع نص رقم المستخدم 
        {
            if (Properties == true && Events == false)
            {
                ElementsTools.TextBox_.CustumProperties(txt05002002, "en-us");

            }
            else if (Properties == true && Events == true)
            {
                ElementsTools.TextBox_.CustumProperties(txt05002002, "en-us", ColorPropertyName.BackColor_1,ColorPropertyName.ForeColor_1, true, true);
            }
        }
        ...
        private void txt05002004EventsAndProperties(bool Properties, bool Events = false) // مربع نص اسم المستخدم 
        {
            if (Properties == true && Events == false)
            {
                ElementsTools.TextBox_.CustumProperties(txt05002004, "en-us", ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1);

            }
            else if (Properties == true && Events == true)
            {
                ElementsTools.TextBox_.CustumProperties(txt05002004, "en-us", ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1, true, true);
        ...
        private void txt05002006EventsAndProperties(bool Properties, bool Events = false) // مربع نص كلمة المرور 
        {
            if (Properties == true && Events == false)
            {
                ElementsTools.TextBox_.CustumProperties(txt05002006, "en-us", ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1);

            }
            else if (Properties == true && Events == true)
            {
                ElementsTools.TextBox_.CustumProperties(txt05002006, "en-us", ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1, true, true);
            ...
            if (Properties == true && Events == false)
            {
                try
                {
                    if (TblUsersAccounts.Rows.Count > 0)
                    {
                        ...
                        dgv05003.Columns[12].Visible = false;
