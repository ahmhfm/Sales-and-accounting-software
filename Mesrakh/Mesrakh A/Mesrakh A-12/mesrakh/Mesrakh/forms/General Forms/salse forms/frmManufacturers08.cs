...
namespace Mesrakh
{
    public partial class frmManufacturers08 : Form
    {
        ...
        private void txt08001002002EventsAndProperties(bool Properties = true, bool Events = false) // مربع نص اسم الشركة عربي
        {
            ...
            if (Properties == true && Events == false)
            {
                ElementsTools.TextBox_.CustumProperties(txt08001002002, cultureInfo,100);
            }
            else if (Properties == true && Events == true)
            {
                ElementsTools.TextBox_.CustumProperties(txt08001002002, cultureInfo,100, ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1, true, true);
        ...
        private void txt08001002003EventsAndProperties(bool Properties, bool Events = false) // مربع نص اسم الشركة انجليزي
        {
            ...
            if (Properties == true && Events == false)
            {
                ElementsTools.TextBox_.CustumProperties(txt08001002003, cultureInfo,100);
            }
            else if (Properties == true && Events == true)
            {
                ElementsTools.TextBox_.CustumProperties(txt08001002003, cultureInfo,100, ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1, true, true);
