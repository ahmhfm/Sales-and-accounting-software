...
public class Cultures
{
    ...
    public static void fillTranslationTable()
    {
        if (tblTranslation is null)
        {
            ...
            tblTranslation.Rows.Add(new string[] { "434", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "435", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "436", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "437", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "438", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "439", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "440", "", "", "" });
