...
namespace Mesrakh
{
    public partial class frmLogin03 : Form
    {
        ...
        {
            InitializeComponent();
            Allfrm03ElementsEventsAndProperties(true, true); // جميع العناصر
        }

        public  void Allfrm03ElementsEventsAndProperties(bool Properties, bool Events = false)  //  جميع العناصر
        {
        ...
        private void txt03001002EventsAndProperties(bool Properties, bool Events = false) // مربع نص اسم المستخدم
        {
            ...
            if (Properties == true && Events == false)
            {
                ElementsTools.TextBox_.CustumProperties(txt03001002,"en-us");
            }
            else if (Properties == true && Events == true)
            {
                ElementsTools.TextBox_.CustumProperties(txt03001002, "en-us", ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1, true, true);
        ...
        private void txt03001004EventsAndProperties(bool Properties, bool Events = false) // مربط نص كلمة المرور
        {
            ...
            if (Properties == true && Events == false)
            {
                ElementsTools.TextBox_.CustumProperties(txt03001004, "en-us");
            }
            else if (Properties == true && Events == true)
            {
                ElementsTools.TextBox_.CustumProperties(txt03001004, "en-us", ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1, true, true);
