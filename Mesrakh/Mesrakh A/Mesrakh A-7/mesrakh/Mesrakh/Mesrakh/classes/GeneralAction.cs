...
public class GeneralAction
{
    ...
    {
        if (GeneralVariables._frmMain01 != null) { GeneralVariables._frmMain01.AllElementsEventsAndProperties(true); } // تحديث خصائص عناصر النموذج الرئيسي
        if (GeneralVariables._frmConnectionSettings != null) { GeneralVariables._frmConnectionSettings.Allfrm02ElementsEventsAndProperties(true); } // تحديث خصائص جميع عناصر نموذج نص الاتصال
        if (GeneralVariables._frmLogin03 != null) { GeneralVariables._frmLogin03.Allfrm03ElementsEventsAndProperties(true); } // تحديث خصائص جميع عناصر نموذج الدخول
        if (GeneralVariables._frmNotifications != null) { GeneralVariables._frmNotifications.AllElementsEventsAndProperties(true); } // تحديث خصائص نموذج الاشعارات
        if (GeneralVariables._frmAccount05 != null) { GeneralVariables._frmAccount05.Allfrm05ElementsEventsAndProperties(true); } // تحديث خصائص نموذج حسابات المستخدمين
        if (GeneralVariables._frmMainMenu06 != null) { GeneralVariables._frmMainMenu06.AllfrmMainMenu06ElementsEventsAndProperties(true); } // تحديث خصائص نموذج القائمة الرئيسية
        if (GeneralVariables._frmManufacturers08 != null) { GeneralVariables._frmManufacturers08.Allfrm08ElementsEventsAndProperties(true); } // تحديث خصائص نموذج الشركات الصانعة
        if (GeneralVariables._frmPermissionsGroup07 != null) { GeneralVariables._frmPermissionsGroup07.Allfrm07ElementsEventsAndProperties(true); } // تحديث خصائص نموذج مجموعات الصلاحيات
        if (GeneralVariables._frmProducts09 != null) { GeneralVariables._frmProducts09.AllfrmProducts09ElementsEventsAndProperties(true); } // تحديث خصائص نموذج المنتجات
        if (GeneralVariables._frmCategories10 != null) { GeneralVariables._frmCategories10.AllfrmProductsCategories10ElementsEventsAndProperties(true); } // تحديث خصائص نموذج التصنيفات
        if (GeneralVariables._frmAccounts11 != null) { GeneralVariables._frmAccounts11.AllfrmAccounts11ElementsEventsAndProperties(true); } // تحديث خصائص نموذج الحسابات المحاسبية
        if (GeneralVariables._frmMeasureUnit12 != null) { GeneralVariables._frmMeasureUnit12.AllfrmMeasureUnit12ElementsEventsAndProperties(true); } // تحديث خصائص نموذج وحدات القياس
        if (GeneralVariables._frmEncapsulationUnits13 != null) { GeneralVariables._frmEncapsulationUnits13.AllfrmEncapsulationUnits13ElementsEventsAndProperties(true); } // تحديث خصائص نموذج وحدات القياس
