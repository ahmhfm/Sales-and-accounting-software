...
public class Cultures
{
    ...
    public static void fillTranslationTable()
    {
        if (tblTranslation is null)
        {
            ...
            tblTranslation.Rows.Add(new string[] { "399", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "400", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "401", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "402", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "403", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "404", "", "", "" });
