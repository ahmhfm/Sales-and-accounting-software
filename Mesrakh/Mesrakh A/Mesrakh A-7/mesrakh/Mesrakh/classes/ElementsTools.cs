...
class ElementsTools
{
    ...
    public class TextBox_
    {
        ...
        /// <param name="Properties">Optional : Update The properties / bool Variable</param>
        /// <param name="Events">Optional : Update The Events / bool Variable</param>
        public static void CustumProperties(TextBox textbox , string cultureInfo = "" ,int Length = 200 , ColorPropertyName BackColor = ColorPropertyName.BackColor_1, ColorPropertyName ForColor = ColorPropertyName.ForeColor_1, bool Properties = true , bool Events = false , TextBoxType textBoxType = TextBoxType.String)
        {
    ...
    public class TabControl_
    {
        ...
        /// <param name="Properties">Optional : Update The properties / bool Variable</param>
        /// <param name="Events">Optional : Update The Events / bool Variable</param>
        public static void CustumProperties(TabControl tabControl,string[] PagesNames, ColorPropertyName BackColor = ColorPropertyName.BackColor_1, ColorPropertyName ForeColor = ColorPropertyName.ForeColor_1, bool Properties = true, bool Events = false)
        {
            if (Properties)
            {
                try
