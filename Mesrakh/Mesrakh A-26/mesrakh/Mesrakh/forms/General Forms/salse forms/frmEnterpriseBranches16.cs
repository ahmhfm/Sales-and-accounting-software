...
namespace Mesrakh
{
    public partial class frmEnterpriseBranches16 : Form
    {
        ...
        public void AllEventsAndProperties(bool Properties, bool Events = false)  //  جميع العناصر
        {
            ...
            //------------ الحاوية الجانبية
            tabsNamesEventsAndProperties(Properties, Events);// حاوية النماذج الفرعية 
            ...
            lblUnitAccountInBranchEventsAndProperties(Properties, Events);  // ملصق رقم الحساب المحاسبي لوحدة العمليات
            txtUnitAccountInBranchEventsAndProperties(Properties, Events);  // مربع نص رقم الحساب المحاسبي لوحدة العمليات
            ...
            //-------------- الحسابات البنكية
            lblBankAccountsEventsAndProperties(Properties, Events); // ملصق عنوان جزء الحسابات البنكية
            lbl003001EventsAndProperties(Properties, Events); // ملصق اسم صاحب الحساب
            txt003001EventsAndProperties(Properties, Events); // مربع نص اسم صاحب الحساب
            lbl003002EventsAndProperties(Properties, Events); // ملصق إسم البنك
            txt003002EventsAndProperties(Properties, Events); // مربع نص إسم البنك
            lbl003003EventsAndProperties(Properties, Events); // ملصق رقم الحساب
            txt003003EventsAndProperties(Properties, Events); // مربع نص رقم الحساب
            lbl003004EventsAndProperties(Properties, Events); // ملصق رقم الآيبان
            txt003004EventsAndProperties(Properties, Events); // مربع نص رقم الآيبان
            lbl003005EventsAndProperties(Properties, Events); // ملصق رقم الحساب
            txt003005EventsAndProperties(Properties, Events); // مربع نص رقم الحساب
            btn003001EventsAndProperties(Properties, Events); // زر اضافة حساب بنكي
            btn003002EventsAndProperties(Properties, Events); // زر حذف حساب بنكي
            dgv003001EventsAndProperties(Properties, Events); // جدول عرض الأرفف


            //--------------- صناديق النقدية
            lblCashBoxesEventsAndProperties(Properties, Events); // ملصق عنوان جزء صناديق النقدية
            lbl004001EventsAndProperties(Properties, Events); // ملصق رمز الصندوق
            txt004001EventsAndProperties(Properties, Events); // مربع نص رمز الصندوق
            lbl004002EventsAndProperties(Properties, Events); // ملصق رقم الحساب
            txt004002EventsAndProperties(Properties, Events); // مربع نص رقم الحساب
            btn004001EventsAndProperties(Properties, Events); // زر اضافة صندوق نقدية
            btn004002EventsAndProperties(Properties, Events); // زر حذف صندوق نقدية
            dgv004001EventsAndProperties(Properties, Events); // جدول عرض صناديق النقدية
                ...
                dgv08001.SelectionChanged += delegate
                {
                    try
                    {
                        if (dgv08001.Rows.Count > 0)
                        {
                            ...
                            fillTblBankAccounts();//تحديث جدول حفظ بيانات الحسابات البنكية
                            dgv003001EventsAndProperties(true);//تحديث جدول عرض بيانات الحسابت البنكية

                            fillTblCashBoxes();//تحديث جدول حفظ بيانات صناديق النقدية
                            dgv004001EventsAndProperties(true);//تحديث جدول عرض بيانات صناديق النقدية
                        }
                    }
                    catch (Exception ex)
                    {
        ...
        private void tabsNamesEventsAndProperties(bool Properties, bool Events = false) // حاوية النماذج الفرعية 
        {

            if (Properties == true && Events == false)
            {
                List<string> tabsNames = new List<string>();
                tabsNames.Add(Cultures.ReturnTranslation("وحدات العمليات"));
                tabsNames.Add(Cultures.ReturnTranslation("الأرفف"));
                tabsNames.Add(Cultures.ReturnTranslation("الحسابات البنكية"));
                tabsNames.Add(Cultures.ReturnTranslation("صناديق النقدية"));

                ElementsTools.TabControl_.CustumProperties(tabControl1, tabsNames, ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1, true, false);
            }
            else if (Properties == true && Events == true)
            {
                List<string> tabsNames = new List<string>() ;
                ...
                ElementsTools.TabControl_.CustumProperties(tabControl1, tabsNames, ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1, true, true);
            }
        }
        ...
        private void lblOperationUnitsEventsAndProperties(bool Properties, bool Events = false) // ملصق عنوان وحدات العمليات
        {
            ...
            if (Properties == true & Events == false)
            {
                ElementsTools.Lable_.CustumProperties(lblOperationUnits, "وحدات العمليات", ColorPropertyName.BackColor_4, ColorPropertyName.ForeColor_4);
            }
            else if (Properties == true & Events == true)
            {
                ElementsTools.Lable_.CustumProperties(lblOperationUnits, "وحدات العمليات", ColorPropertyName.BackColor_4, ColorPropertyName.ForeColor_4, true, true);
            }
        }
        ...
        private void lblUnitNoInBranchEventsAndProperties(bool Properties, bool Events = false) // ملصق عنوان وحدات العمليات
        {
            ...
            if (Properties == true & Events == false)
            {
                ElementsTools.Lable_.CustumProperties(lblUnitNoInBranch, "رمز الوحدة", ColorPropertyName.BackColor_4, ColorPropertyName.ForeColor_4);
            }
            else if (Properties == true & Events == true)
            {
                ElementsTools.Lable_.CustumProperties(lblUnitNoInBranch, "رمز الوحدة", ColorPropertyName.BackColor_4, ColorPropertyName.ForeColor_4, true, true);
            }
        }
        ...
        private void txtUnitNoInBranchEventsAndProperties(bool Properties = true, bool Events = false) // مربع نص رمز وحدة العمليات في الفرع
        {
            ...
            else if (Properties == true && Events == true)
            {
                ...
                {
                    if (e.KeyData == Keys.Enter) { txtUnitAccountInBranch.Focus(); };

                };
            }
        }

        private void lblUnitAccountInBranchEventsAndProperties(bool Properties, bool Events = false) // ملصق رقم الحساب المحاسبي لوحدة العمليات
        {

            if (Properties == true & Events == false)
            {
                ElementsTools.Lable_.CustumProperties(lblUnitAccountInBranch, "رقم الحساب المحاسبي", ColorPropertyName.BackColor_4, ColorPropertyName.ForeColor_4);
            }
            else if (Properties == true & Events == true)
            {
                ElementsTools.Lable_.CustumProperties(lblUnitAccountInBranch, "رقم الحساب المحاسبي", ColorPropertyName.BackColor_4, ColorPropertyName.ForeColor_4, true, true);
            }
        }

        private void txtUnitAccountInBranchEventsAndProperties(bool Properties = true, bool Events = false) // مربع نص رقم الحساب المحاسبي لوحدة العمليات
        {
            string cultureInfo = "en-US";
            if (Properties == true && Events == false)
            {
                ElementsTools.TextBox_.CustumProperties(txtUnitAccountInBranch, cultureInfo, 50);
            }
            else if (Properties == true && Events == true)
            {
                ElementsTools.TextBox_.CustumProperties(txtUnitAccountInBranch, cultureInfo, 50, ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1, true, true);

                txtUnitAccountInBranch.KeyDown += delegate (object sender, KeyEventArgs e)
                {
        ...
        private void addUnitBranchEventsAndProperties(bool Properties, bool Events = false) // زر اضافة وحدة عمليات
        {
            if (Properties == true && Events == false)
            {
                ElementsTools.Button_.CustumProperties(addUnitBranch, "إضافة", ColorPropertyName.ForeColor_2);
            }
            else if (Properties == true && Events == true)
            {
                ElementsTools.Button_.CustumProperties(addUnitBranch, "إضافة", ColorPropertyName.ForeColor_2, true, true);
                    ...
                    try
                    {
                        if (Permissions.AccountHavePermission(PermissionObjectes.Unit_Branch, PermissionType.Add))
                        {
                            ...
                            if (addUnitBranch.Text == Cultures.ReturnTranslation("إضافة"))
                            {
                                ...
                                txtUnitAccountInBranch.Enabled = true;
                                txtUnitAccountInBranch.Text = "";
                            ...
                            else
                            {
                                ...
                                if (check == "")
                                {
                                    ...
                                    string[] result = null;
                                    object x = DataTools.DataBases.Run(ref result, "insert into TblOperationUnits values (@BranchNumber,@UnitNoInBranch,null,@txtUnitAccountInBranch)", CommandType.Text, new object[][] { new object[] { "@BranchNumber", txt08001002001.Text }, new object[] { "@UnitNoInBranch", txtUnitNoInBranch.Text }, new object[] { "@txtUnitAccountInBranch", txtUnitAccountInBranch.Text } });

                                    addUnitBranch.Text = Cultures.ReturnTranslation("إضافة");
                                    txtUnitNoInBranch.Enabled = false;
                                    txtUnitAccountInBranch.Enabled = false;
        ...
        private void btnDeleteUnitBranchEventsAndProperties(bool Properties, bool Events = false) // زر حذف وحدات العمليات
        {
            if (Properties == true && Events == false)
            {
                ElementsTools.Button_.CustumProperties(btnDeleteUnitBranch, "حذف", ColorPropertyName.ForeColor_2);
            }
            else if (Properties == true && Events == true)
            {
                ElementsTools.Button_.CustumProperties(btnDeleteUnitBranch, "حذف", ColorPropertyName.ForeColor_2, true, true);
            ...
            if (Properties == true && Events == false)
            {
                ...
                try
                {
                    ...
                    if (TblOperationUnits.Rows.Count > 0)
                    {
                        ...
                        dgvUnitBranch.Columns[4].HeaderText = Cultures.ReturnTranslation("رقم الحساب"); 
                        dgvUnitBranch.Columns[4].AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill;
                    ...
                    try
                    {
                        if (dgvUnitBranch.SelectedRows != null)
                        {
                            if (dgvUnitBranch.SelectedRows.Count > 0)
                            {
                                ...
                                txtUnitAccountInBranch.Text = dgvUnitBranch.SelectedRows[0].Cells[4].Value.ToString();
                            }
                        }
        ...
        private void lblShelvesEventsAndProperties(bool Properties, bool Events = false) // ملصق عنوان جزءالرفوف
        {
            ...
            if (Properties == true & Events == false)
            {
                ElementsTools.Lable_.CustumProperties(lblShelves, "الأرفف", ColorPropertyName.BackColor_4, ColorPropertyName.ForeColor_4);
            }
            else if (Properties == true & Events == true)
            {
                ElementsTools.Lable_.CustumProperties(lblShelves, "الأرفف", ColorPropertyName.BackColor_4, ColorPropertyName.ForeColor_4, true, true);
            }
        }
        ...
        private void lblShelfGeneralNoEventsAndProperties(bool Properties, bool Events = false) // ملصق كود الرف
        {
            ...
            if (Properties == true & Events == false)
            {
                ElementsTools.Lable_.CustumProperties(lblShelfGeneralNo, "رمز الرف", ColorPropertyName.BackColor_4, ColorPropertyName.ForeColor_4);
            }
            else if (Properties == true & Events == true)
            {
                ElementsTools.Lable_.CustumProperties(lblShelfGeneralNo, "رمز الرف", ColorPropertyName.BackColor_4, ColorPropertyName.ForeColor_4, true, true);
            }
        }
        ...
        private void btnAddShelfEventsAndProperties(bool Properties, bool Events = false) // زر اضافة رف
        {
            if (Properties == true && Events == false)
            {
                ElementsTools.Button_.CustumProperties(btnAddShelf, "إضافة", ColorPropertyName.ForeColor_2);
            }
            else if (Properties == true && Events == true)
            {
                ElementsTools.Button_.CustumProperties(btnAddShelf, "إضافة", ColorPropertyName.ForeColor_2, true, true);
        ...
        private void btnDeleteShelfEventsAndProperties(bool Properties, bool Events = false) // زر حذف رف
        {
            if (Properties == true && Events == false)
            {
                ElementsTools.Button_.CustumProperties(btnDeleteShelf, "حذف", ColorPropertyName.ForeColor_2);
            }
            else if (Properties == true && Events == true)
            {
                ElementsTools.Button_.CustumProperties(btnDeleteShelf, "حذف", ColorPropertyName.ForeColor_2, true, true);
        ...
        private void lblBankAccountsEventsAndProperties(bool Properties, bool Events = false) // ملصق عنوان جزء الحسابات البنكية
        {

            if (Properties == true & Events == false)
            {
                ElementsTools.Lable_.CustumProperties(lblBankAccounts, "الحسابات البنكية", ColorPropertyName.BackColor_4, ColorPropertyName.ForeColor_4);
            }
            else if (Properties == true & Events == true)
            {
                ElementsTools.Lable_.CustumProperties(lblBankAccounts, "الحسابات البنكية", ColorPropertyName.BackColor_4, ColorPropertyName.ForeColor_4, true, true);
            }
        }

        private void lbl003001EventsAndProperties(bool Properties, bool Events = false) // ملصق اسم صاحب الحساب
        {

            if (Properties == true & Events == false)
            {
                ElementsTools.Lable_.CustumProperties(lbl003001, "إسم مالك الحساب", ColorPropertyName.BackColor_4, ColorPropertyName.ForeColor_4);
            }
            else if (Properties == true & Events == true)
            {
                ElementsTools.Lable_.CustumProperties(lbl003001, "إسم مالك الحساب", ColorPropertyName.BackColor_4, ColorPropertyName.ForeColor_4, true, true);
            }
        }


        private void txt003001EventsAndProperties(bool Properties = true, bool Events = false) // مربع نص اسم صاحب الحساب
        {
            string cultureInfo = "";
            if (Properties == true && Events == false)
            {
                ElementsTools.TextBox_.CustumProperties(txt003001, cultureInfo, 50);
            }
            else if (Properties == true && Events == true)
            {
                ElementsTools.TextBox_.CustumProperties(txt003001, cultureInfo, 50, ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1, true, true);

                txt003001.KeyDown += delegate (object sender, KeyEventArgs e)
                {
                    if (e.KeyData == Keys.Enter) { txt003002.Select(); };

                };
            }
        }

        private void lbl003002EventsAndProperties(bool Properties, bool Events = false) // ملصق إسم البنك
        {

            if (Properties == true & Events == false)
            {
                ElementsTools.Lable_.CustumProperties(lbl003002, "إسم البنك", ColorPropertyName.BackColor_4, ColorPropertyName.ForeColor_4);
            }
            else if (Properties == true & Events == true)
            {
                ElementsTools.Lable_.CustumProperties(lbl003002, "إسم البنك", ColorPropertyName.BackColor_4, ColorPropertyName.ForeColor_4, true, true);
            }
        }


        private void txt003002EventsAndProperties(bool Properties = true, bool Events = false) // مربع نص إسم البنك
        {
            string cultureInfo = "";
            if (Properties == true && Events == false)
            {
                ElementsTools.TextBox_.CustumProperties(txt003002, cultureInfo, 50);
            }
            else if (Properties == true && Events == true)
            {
                ElementsTools.TextBox_.CustumProperties(txt003002, cultureInfo, 50, ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1, true, true);

                txt003002.KeyDown += delegate (object sender, KeyEventArgs e)
                {
                    if (e.KeyData == Keys.Enter) { txt003003.Select(); };

                };
            }
        }

        private void lbl003003EventsAndProperties(bool Properties, bool Events = false) // ملصق رقم الحساب
        {

            if (Properties == true & Events == false)
            {
                ElementsTools.Lable_.CustumProperties(lbl003003, "رقم الحساب", ColorPropertyName.BackColor_4, ColorPropertyName.ForeColor_4);
            }
            else if (Properties == true & Events == true)
            {
                ElementsTools.Lable_.CustumProperties(lbl003003, "رقم الحساب", ColorPropertyName.BackColor_4, ColorPropertyName.ForeColor_4, true, true);
            }
        }


        private void txt003003EventsAndProperties(bool Properties = true, bool Events = false) // مربع نص رقم الحساب
        {
            string cultureInfo = "en-US";
            if (Properties == true && Events == false)
            {
                ElementsTools.TextBox_.CustumProperties(txt003003, cultureInfo, 50);
            }
            else if (Properties == true && Events == true)
            {
                ElementsTools.TextBox_.CustumProperties(txt003003, cultureInfo, 50, ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1, true, true);

                txt003003.KeyDown += delegate (object sender, KeyEventArgs e)
                {
                    if (e.KeyData == Keys.Enter) { txt003004.Select(); };

                };
            }
        }

        private void lbl003004EventsAndProperties(bool Properties, bool Events = false) // ملصق رقم الآيبان
        {

            if (Properties == true & Events == false)
            {
                ElementsTools.Lable_.CustumProperties(lbl003004, "رقم الآيبان", ColorPropertyName.BackColor_4, ColorPropertyName.ForeColor_4);
            }
            else if (Properties == true & Events == true)
            {
                ElementsTools.Lable_.CustumProperties(lbl003004, "رقم الآيبان", ColorPropertyName.BackColor_4, ColorPropertyName.ForeColor_4, true, true);
            }
        }


        private void txt003004EventsAndProperties(bool Properties = true, bool Events = false) // مربع نص رقم الآيبان
        {
            string cultureInfo = "en-US";
            if (Properties == true && Events == false)
            {
                ElementsTools.TextBox_.CustumProperties(txt003004, cultureInfo, 50);
            }
            else if (Properties == true && Events == true)
            {
                ElementsTools.TextBox_.CustumProperties(txt003004, cultureInfo, 50, ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1, true, true);

                txt003004.KeyDown += delegate (object sender, KeyEventArgs e)
                {
                    if (e.KeyData == Keys.Enter) { txt003005.Select(); };

                };
            }
        }

        private void lbl003005EventsAndProperties(bool Properties, bool Events = false) // ملصق رقم الحساب
        {

            if (Properties == true & Events == false)
            {
                ElementsTools.Lable_.CustumProperties(lbl003005, "رقم الحساب", ColorPropertyName.BackColor_4, ColorPropertyName.ForeColor_4);
            }
            else if (Properties == true & Events == true)
            {
                ElementsTools.Lable_.CustumProperties(lbl003005, "رقم الحساب", ColorPropertyName.BackColor_4, ColorPropertyName.ForeColor_4, true, true);
            }
        }


        private void txt003005EventsAndProperties(bool Properties = true, bool Events = false) // مربع نص رقم الحساب
        {
            string cultureInfo = "";
            if (Properties == true && Events == false)
            {
                ElementsTools.TextBox_.CustumProperties(txt003005, cultureInfo, 10);
            }
            else if (Properties == true && Events == true)
            {
                ElementsTools.TextBox_.CustumProperties(txt003005, cultureInfo, 10, ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1, true, true);

                txt003005.KeyDown += delegate (object sender, KeyEventArgs e)
                {
                    if (e.KeyData == Keys.Enter) { btn003001.PerformClick(); };

                };
            }
        }

        private void btn003001EventsAndProperties(bool Properties, bool Events = false) // زر اضافة حساب بنكي
        {
            if (Properties == true && Events == false)
            {
                ElementsTools.Button_.CustumProperties(btn003001, "إضافة", ColorPropertyName.ForeColor_2);
            }
            else if (Properties == true && Events == true)
            {
                ElementsTools.Button_.CustumProperties(btn003001, "إضافة", ColorPropertyName.ForeColor_2, true, true);

                btn003001.Click += delegate
                {
                    try
                    {
                        if (Permissions.AccountHavePermission(PermissionObjectes.Bank_Accounts, PermissionType.Add))
                        {

                            if (btn003001.Text == Cultures.ReturnTranslation("إضافة"))
                            {
                                btn003001.Text = Cultures.ReturnTranslation("حفظ");
                                txt003001.Enabled = true;
                                txt003001.Text = "";
                                txt003002.Enabled = true;
                                txt003002.Text = "";
                                txt003003.Enabled = true;
                                txt003003.Text = "";
                                txt003004.Enabled = true;
                                txt003004.Text = "";
                                txt003005.Enabled = true;
                                txt003005.Text = "";
                                dgvShelves.Enabled = true;
                            ...
                            else
                            {
                                ...
                                if (txt08001002001.Text.Trim() == "")
                                {
                                    check += Cultures.ReturnTranslation("رجاء قم بتحديد الفرع الذي تريد إضافة حساب بنكي جديد إليه");
                                    btn003001.Text = Cultures.ReturnTranslation("إضافة");
                                }
                                else if (txt003001.Text.Trim() == "")
                                {
                                    check += Cultures.ReturnTranslation("رجاء قم بتسجيل إسم مالك الحساب");
                                    txt003001.Focus();
                                }
                                else if (txt003002.Text.Trim() == "")
                                {
                                    check += Cultures.ReturnTranslation("رجاء قم بتسجيل إسم البنك");
                                    txt003002.Focus();
                                }
                                else if (txt003003.Text.Trim() == "")
                                {
                                    check += Cultures.ReturnTranslation("رجاء قم بتسجيل رقم الحساب البنكي");
                                    txt003003.Focus();
                                }
                                else if (txt003004.Text.Trim() == "")
                                {
                                    check += Cultures.ReturnTranslation("رجاء قم بتسجيل رقم الآيبان");
                                    txt003004.Focus();
                                }
                                else if (txt003005.Text.Trim() == "")
                                {
                                    check += Cultures.ReturnTranslation("رجاء قم بتسجيل رقم الحساب المحاسبي");
                                    txt003005.Focus();
                                }
                                else
                                {
                                    bool? SameBankAccount = ElementsTools.DataGridView_.findValueThenSelected(dgv003001, ActionType.add, txt003003.Text.Replace("'", ""), 4);
                                    bool? SameIbanNumber = ElementsTools.DataGridView_.findValueThenSelected(dgv003001, ActionType.add, txt003004.Text.Replace("'", ""), 5);
                                    bool? SameAccountNumber = ElementsTools.DataGridView_.findValueThenSelected(dgv003001, ActionType.add, txt003005.Text.Replace("'", ""), 6);

                                    if (SameBankAccount == true)
                                    {
                                        check = Cultures.ReturnTranslation("يوجد حساب بنكي يحمل نفس الرقم");
                                        txt003003.Focus();

                                    }
                                    else
                                    {
                                        if (SameIbanNumber == true)
                                        {
                                            check = Cultures.ReturnTranslation("يوجد رقم آيبان يحمل نفس الرقم");
                                            txt003004.Focus();

                                        }
                                        else
                                        {
                                            if (SameAccountNumber == true)
                                            {
                                                check = Cultures.ReturnTranslation("يوجد حساب محاسبي يحمل نفس الرقم");
                                                txt003005.Focus();
                                            }
                                        }
                                    }
                                ...
                                if (check == "")
                                {
                                    ...
                                    string[] result = null;
                                    object x = DataTools.DataBases.Run(ref result, "insert into TblBankAccounts  values (@BranchNumber,@AccountHoldersName,@Bank,@BankAccountNumber,@IBAN,@AccountNo)", 
                                        CommandType.Text, 
                                        new object[][] { 
                                            new object[] { "@AccountHoldersName", txt003001.Text },
                                            new object[] { "@Bank", txt003002.Text },
                                            new object[] { "@BankAccountNumber", txt003003.Text },
                                            new object[] { "@IBAN", txt003004.Text },
                                            new object[] { "@AccountNo", txt003005.Text },
                                            new object[] { "@BranchNumber", txt08001002001.Text } 
                                        });

                                    btn003001.Text = Cultures.ReturnTranslation("إضافة");
                                    txt003001.Enabled = false;
                                    txt003002.Enabled = false;
                                    txt003003.Enabled = false;
                                    txt003004.Enabled = false;
                                    txt003005.Enabled = false;

                                    fillTblBankAccounts(); // تعبئة جدول الحسابات البنكية
                                    dgv003001EventsAndProperties(true);
                                    btn003001.Focus();
                                }
                                else
                                {
        ...
        private void btn003002EventsAndProperties(bool Properties, bool Events = false) // زر حذف حساب بنكي
        {
            if (Properties == true && Events == false)
            {
                ElementsTools.Button_.CustumProperties(btn003002, "حذف", ColorPropertyName.ForeColor_2);
            }
            else if (Properties == true && Events == true)
            {
                ElementsTools.Button_.CustumProperties(btn003002, "حذف", ColorPropertyName.ForeColor_2, true, true);

                btn003002.Click += delegate
                {
                    try
                    {
                        if (Permissions.AccountHavePermission(PermissionObjectes.Bank_Accounts, PermissionType.Delete))
                        {
                            int xxx = 0;
                            if (dgv003001.Rows.Count > 0)
                            {
                                if (dgv003001.SelectedRows != null)
                                {
                                    if (dgv003001.SelectedRows.Count > 0)
                                    {
                                        xxx = int.Parse(dgv003001.SelectedRows[0].Cells[0].Value.ToString());
                                    }
                                    else
                                    {
                                        frmMessageBox.ShowMessageBox(Cultures.ReturnTranslation("تنبيه"), Cultures.ReturnTranslation("رجاء قم بالضغط على الحساب البنكي الذي ترغب في حذفه"), MessageBoxStatus.Ok);
                            ...
                            {
                                string[] result = null;
                                object r = DataTools.DataBases.Run(ref result, "delete from TblBankAccounts  where Number = @Number", CommandType.Text, new object[][] { new object[] { "@Number", xxx } });
                                
                                fillTblBankAccounts(); // تعبئة جدول وحدات العمليات
                                dgv003001EventsAndProperties(true);
                                txt003001.Text = "";
                                txt003002.Text = "";
                                txt003003.Text = "";
                        ...
                        {
                            frmMessageBox.ShowMessageBox(Cultures.ReturnTranslation("تنبيه"), Cultures.ReturnTranslation("لا توجد لديك صلاحية للوصول رجاء تواصل مع مدير النظام"), MessageBoxStatus.Ok);
                            GeneralAction.AddNewNotification("frmEnterpriseBranches16 >> btn003002EventsAndProperties", DateTime.Now, "لا توجد لديك صلاحية للوصول رجاء تواصل مع مدير النظام", "You do not have access, please contact the system administrator");
                        }
                    }
                    catch (Exception ex)
                    {
                        frmMessageBox.ShowMessageBox(Cultures.ReturnTranslation("تنبيه"), ex.Message, MessageBoxStatus.Ok);
                        GeneralAction.AddNewNotification("frmEnterpriseBranches16 >> btn003002EventsAndProperties ", DateTime.Now, ex.Message, ex.Message);
                    }
        ...
        private void dgv003001EventsAndProperties(bool Properties, bool Events = false) // جدول عرض الحسابات البنكية
        {
            if (Properties == true && Events == false)
            {
                ...
                try
                {
                    if (TblBankAccounts is null) fillTblBankAccounts();
                    if (TblBankAccounts.Rows.Count > 0)
                    {
                        dgv003001.DataSource = TblBankAccounts;
                        dgv003001.Columns[0].Visible = false;
                        dgv003001.Columns[1].Visible = false;
                        dgv003001.Columns[2].HeaderText = Cultures.ReturnTranslation("إسم مالك الحساب");
                        dgv003001.Columns[2].AutoSizeMode = DataGridViewAutoSizeColumnMode.DisplayedCells;
                        dgv003001.Columns[3].HeaderText = Cultures.ReturnTranslation("البنك");
                        dgv003001.Columns[3].AutoSizeMode = DataGridViewAutoSizeColumnMode.DisplayedCells;
                        dgv003001.Columns[4].HeaderText = Cultures.ReturnTranslation("رقم الحساب البنكي");
                        dgv003001.Columns[4].AutoSizeMode = DataGridViewAutoSizeColumnMode.DisplayedCells;
                        dgv003001.Columns[5].HeaderText = Cultures.ReturnTranslation("رقم الآيبان");
                        dgv003001.Columns[5].AutoSizeMode = DataGridViewAutoSizeColumnMode.DisplayedCells;
                        dgv003001.Columns[6].HeaderText = Cultures.ReturnTranslation("رقم الحساب المحاسبي");
                        dgv003001.Columns[6].AutoSizeMode = DataGridViewAutoSizeColumnMode.DisplayedCells;

                        ElementsTools.DataGridView_.CustumProperties(dgv003001);
                    }
                    else
                    {
                        dgv003001.DataSource = null;
                        dgv003001.Rows.Clear();
                        ElementsTools.DataGridView_.CustumProperties(dgv003001);
                    }
                }
                catch (Exception ex)
            ...
            if (Properties == true && Events == true)
            {
                ...
                try
                {
                    ...
                    if (TblBankAccounts.Rows.Count > 0)
                    {
                        ...
                        dgv003001.Columns[5].HeaderText = Cultures.ReturnTranslation("رقم الآيبان");
                        dgv003001.Columns[5].AutoSizeMode = DataGridViewAutoSizeColumnMode.DisplayedCells;
                        dgv003001.Columns[6].HeaderText = Cultures.ReturnTranslation("رقم الحساب");
                        dgv003001.Columns[6].AutoSizeMode = DataGridViewAutoSizeColumnMode.DisplayedCells;
                ...
                dgv003001.SelectionChanged += delegate
                {
                    try
                    {
                        if (dgv003001.SelectedRows != null)
                        {
                            if (dgv003001.SelectedRows.Count > 0)
                            {
                                txt003001.Text = dgv003001.SelectedRows[0].Cells[2].Value.ToString();
                                txt003002.Text = dgv003001.SelectedRows[0].Cells[3].Value.ToString();
                                txt003003.Text = dgv003001.SelectedRows[0].Cells[4].Value.ToString();
                                txt003004.Text = dgv003001.SelectedRows[0].Cells[5].Value.ToString();
                                txt003005.Text = dgv003001.SelectedRows[0].Cells[6].Value.ToString();
                            }
                        }
                ...
                dgv003001.DataBindingComplete += delegate
                {
                    ElementsTools.DataGridView_.CustumProperties(dgv003001);
        ...
        DataTable TblBankAccounts = new DataTable(); // جدول بيانات الحسابات البنكية

        // تعبئة جدول الحسابات البنكية 
        private void fillTblBankAccounts()
        {
            try
            {
                if (TblBankAccounts is null) TblBankAccounts = new DataTable();
                if (TblBankAccounts.Rows.Count > 0) { TblBankAccounts.Rows.Clear(); }
                TblBankAccounts = DataTools.DataBases.ReadTabel("select * from TblBankAccounts where BranchNumber = " + txt08001002001.Text);

            }
            catch (Exception ex)
            {
                frmMessageBox.ShowMessageBox(Cultures.ReturnTranslation("تنبيه"), ex.Message, MessageBoxStatus.Ok);
                GeneralAction.AddNewNotification("frmEnterpriseBranches16 >> fillTblBankAccounts ", DateTime.Now, ex.Message, ex.Message);
            }
        }
        ...
        private void lblCashBoxesEventsAndProperties(bool Properties, bool Events = false) // ملصق عنوان جزء صناديق النقدية
        {

            if (Properties == true & Events == false)
            {
                ElementsTools.Lable_.CustumProperties(lblCashBoxes, "صناديق النقدية", ColorPropertyName.BackColor_4, ColorPropertyName.ForeColor_4);
            }
            else if (Properties == true & Events == true)
            {
                ElementsTools.Lable_.CustumProperties(lblCashBoxes, "صناديق النقدية", ColorPropertyName.BackColor_4, ColorPropertyName.ForeColor_4, true, true);
            }
        }

        private void lbl004001EventsAndProperties(bool Properties, bool Events = false) // ملصق رمز الصندوق
        {

            if (Properties == true & Events == false)
            {
                ElementsTools.Lable_.CustumProperties(lbl004001, "رمز الصندوق", ColorPropertyName.BackColor_4, ColorPropertyName.ForeColor_4);
            }
            else if (Properties == true & Events == true)
            {
                ElementsTools.Lable_.CustumProperties(lbl004001, "رمز الصندوق", ColorPropertyName.BackColor_4, ColorPropertyName.ForeColor_4, true, true);
            }
        }


        private void txt004001EventsAndProperties(bool Properties = true, bool Events = false) // مربع نص رمز الصندوق
        {
            string cultureInfo = "en-US";
            if (Properties == true && Events == false)
            {
                ElementsTools.TextBox_.CustumProperties(txt004001, cultureInfo, 50);
            }
            else if (Properties == true && Events == true)
            {
                ElementsTools.TextBox_.CustumProperties(txt004001, cultureInfo, 50, ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1, true, true);

                txt004001.KeyDown += delegate (object sender, KeyEventArgs e)
                {
                    if (e.KeyData == Keys.Enter) { txt004002.Select(); };

                };
            }
        }

        private void lbl004002EventsAndProperties(bool Properties, bool Events = false) // ملصق رقم الحساب
        {

            if (Properties == true & Events == false)
            {
                ElementsTools.Lable_.CustumProperties(lbl004002, "رقم الحساب", ColorPropertyName.BackColor_4, ColorPropertyName.ForeColor_4);
            }
            else if (Properties == true & Events == true)
            {
                ElementsTools.Lable_.CustumProperties(lbl004002, "رقم الحساب", ColorPropertyName.BackColor_4, ColorPropertyName.ForeColor_4, true, true);
            }
        }


        private void txt004002EventsAndProperties(bool Properties = true, bool Events = false) // مربع نص رقم الحساب
        {
            string cultureInfo = "";
            if (Properties == true && Events == false)
            {
                ElementsTools.TextBox_.CustumProperties(txt004002, cultureInfo, 10);
            }
            else if (Properties == true && Events == true)
            {
                ElementsTools.TextBox_.CustumProperties(txt004002, cultureInfo, 10, ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1, true, true);

                txt004002.KeyDown += delegate (object sender, KeyEventArgs e)
                {
                    if (e.KeyData == Keys.Enter) { btn004001.PerformClick(); };

                };
            }
        }

        private void btn004001EventsAndProperties(bool Properties, bool Events = false) // زر اضافة صندوق نقدية
        {
            if (Properties == true && Events == false)
            {
                ElementsTools.Button_.CustumProperties(btn004001, "إضافة", ColorPropertyName.ForeColor_2);
            }
            else if (Properties == true && Events == true)
            {
                ElementsTools.Button_.CustumProperties(btn004001, "إضافة", ColorPropertyName.ForeColor_2, true, true);

                btn004001.Click += delegate
                {
                    try
                    {
                        if (Permissions.AccountHavePermission(PermissionObjectes.Cash_Boxes, PermissionType.Add))
                        {

                            if (btn004001.Text == Cultures.ReturnTranslation("إضافة"))
                            {
                                btn004001.Text = Cultures.ReturnTranslation("حفظ");
                                txt004001.Enabled = true;
                                txt004001.Text = "";
                                txt004002.Enabled = true;
                                txt004002.Text = "";
                                txt004001.Select();
                            }
                            else
                            {
                                ...
                                {
                                    check += Cultures.ReturnTranslation("رجاء قم بتحديد الفرع الذي تريد إضافة حساب بنكي جديد إليه");
                                    btn004001.Text = Cultures.ReturnTranslation("إضافة");
                                }
                                else if (txt004001.Text.Trim() == "")
                                {
                                    check += Cultures.ReturnTranslation("رجاء قم بتسجيل رمز الصندوق");
                                    txt004001.Focus();
                                }
                                else if (txt004002.Text.Trim() == "")
                                {
                                    check += Cultures.ReturnTranslation("رجاء قم بتسجيل رقم الحساب المحاسبي");
                                    txt004002.Focus();
                                }
                                ...
                                {
                                    bool? SameCashBoxes = ElementsTools.DataGridView_.findValueThenSelected(dgv004001, ActionType.add, txt004001.Text.Replace("'", ""), 2);
                                    bool? SameAccountNumber = ElementsTools.DataGridView_.findValueThenSelected(dgv004001, ActionType.add, txt004002.Text.Replace("'", ""), 3);

                                    if (SameCashBoxes == true)
                                    {
                                        check = Cultures.ReturnTranslation("يوجد صندوق نقدية يحمل نفس الرمز");
                                        txt004001.Focus();
                                ...
                                if (check == "")
                                {
                                    ...
                                    string[] result = null;
                                    object x = DataTools.DataBases.Run(ref result, "insert into TblCashBoxes  values (@BranchNumber,@BoxCode,@AccountNo)",
                                        CommandType.Text,
                                        new object[][] {
                                            new object[] { "@BoxCode", txt004001.Text },
                                            new object[] { "@AccountNo", txt004002.Text },
                                            new object[] { "@BranchNumber", txt08001002001.Text }
                                        });

                                    btn004001.Text = Cultures.ReturnTranslation("إضافة");
                                    txt004001.Enabled = false;
                                    txt004002.Enabled = false;


                                    fillTblCashBoxes(); // تعبئة جدول الحسابات البنكية
                                    dgv004001EventsAndProperties(true);
                                    btn004001.Focus();
                                }
                                else
                                {
        ...
        private void btn004002EventsAndProperties(bool Properties, bool Events = false) // زر حذف صندوق نقدية
        {
            if (Properties == true && Events == false)
            {
                ElementsTools.Button_.CustumProperties(btn004002, "حذف", ColorPropertyName.ForeColor_2);
            }
            else if (Properties == true && Events == true)
            {
                ElementsTools.Button_.CustumProperties(btn004002, "حذف", ColorPropertyName.ForeColor_2, true, true);

                btn004002.Click += delegate
                {
                    try
                    {
                        if (Permissions.AccountHavePermission(PermissionObjectes.Cash_Boxes, PermissionType.Delete))
                        {
                            int xxx = 0;
                            if (dgv004001.Rows.Count > 0)
                            {
                                if (dgv004001.SelectedRows != null)
                                {
                                    if (dgv004001.SelectedRows.Count > 0)
                                    {
                                        xxx = int.Parse(dgv004001.SelectedRows[0].Cells[0].Value.ToString());
                                    }
                                    else
                                    {
                                        frmMessageBox.ShowMessageBox(Cultures.ReturnTranslation("تنبيه"), Cultures.ReturnTranslation("رجاء قم بالضغط على صندوق النقدية الذي ترغب في حذفه"), MessageBoxStatus.Ok);
                            ...
                            {
                                string[] result = null;
                                object r = DataTools.DataBases.Run(ref result, "delete from TblCashBoxes where Number = @Number", CommandType.Text, new object[][] { new object[] { "@Number", xxx } });

                                fillTblCashBoxes(); // تعبئة جدول وحدات العمليات
                                dgv004001EventsAndProperties(true);
                                txt004001.Text = "";
                                txt004002.Text = "";
                            }
                        ...
                        {
                            frmMessageBox.ShowMessageBox(Cultures.ReturnTranslation("تنبيه"), Cultures.ReturnTranslation("لا توجد لديك صلاحية للوصول رجاء تواصل مع مدير النظام"), MessageBoxStatus.Ok);
                            GeneralAction.AddNewNotification("frmEnterpriseBranches16 >> btn004002EventsAndProperties", DateTime.Now, "لا توجد لديك صلاحية للوصول رجاء تواصل مع مدير النظام", "You do not have access, please contact the system administrator");
                        }
                    }
                    catch (Exception ex)
                    {
                        frmMessageBox.ShowMessageBox(Cultures.ReturnTranslation("تنبيه"), ex.Message, MessageBoxStatus.Ok);
                        GeneralAction.AddNewNotification("frmEnterpriseBranches16 >> btn004002EventsAndProperties ", DateTime.Now, ex.Message, ex.Message);
                    }
        ...
        private void dgv004001EventsAndProperties(bool Properties, bool Events = false) // جدول عرض صناديق النقدية
        {
            if (Properties == true && Events == false)
            {
                ...
                try
                {
                    if (TblCashBoxes is null) fillTblCashBoxes();
                    if (TblCashBoxes.Rows.Count > 0)
                    {
                        dgv004001.DataSource = TblCashBoxes;
                        dgv004001.Columns[0].Visible = false;
                        dgv004001.Columns[1].Visible = false;
                        dgv004001.Columns[2].HeaderText = Cultures.ReturnTranslation("رمز الصندوق");
                        dgv004001.Columns[2].AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill;
                        dgv004001.Columns[3].HeaderText = Cultures.ReturnTranslation("رقم الحساب المحاسبي");
                        dgv004001.Columns[3].AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill;

                        ElementsTools.DataGridView_.CustumProperties(dgv004001);
                    }
                    else
                    {
                        dgv004001.DataSource = null;
                        dgv004001.Rows.Clear();
                        ElementsTools.DataGridView_.CustumProperties(dgv004001);
                    }
                }
                catch (Exception ex)
                {
                    frmMessageBox.ShowMessageBox(Cultures.ReturnTranslation("تنبيه"), ex.Message, MessageBoxStatus.Ok);
                    GeneralAction.AddNewNotification("frmEnterpriseBranches16 >> dgv004001EventsAndProperties ", DateTime.Now, ex.Message, ex.Message);
                }
            ...
            if (Properties == true && Events == true)
            {
                ...
                dgv004001.SelectionChanged += delegate
                {
                    try
                    {
                        if (dgv004001.SelectedRows != null)
                        {
                            if (dgv004001.SelectedRows.Count > 0)
                            {
                                txt004001.Text = dgv004001.SelectedRows[0].Cells[2].Value.ToString();
                                txt004002.Text = dgv004001.SelectedRows[0].Cells[3].Value.ToString();
                            }
                        }
                ...
                dgv004001.DataBindingComplete += delegate
                {
                    ElementsTools.DataGridView_.CustumProperties(dgv004001);
        ...
        DataTable TblCashBoxes = new DataTable(); // جدول بيانات صناديق النقدية

        // تعبئة جدول صناديق النقدية 
        private void fillTblCashBoxes()
        {
            try
            {
                if (TblCashBoxes is null) TblCashBoxes = new DataTable();
                if (TblCashBoxes.Rows.Count > 0) { TblCashBoxes.Rows.Clear(); }
                TblCashBoxes = DataTools.DataBases.ReadTabel("select * from TblCashBoxes where BranchNumber = " + txt08001002001.Text);

            }
            catch (Exception ex)
            {
                frmMessageBox.ShowMessageBox(Cultures.ReturnTranslation("تنبيه"), ex.Message, MessageBoxStatus.Ok);
                GeneralAction.AddNewNotification("frmEnterpriseBranches16 >> fillTblCashBoxes ", DateTime.Now, ex.Message, ex.Message);
            }
        }
