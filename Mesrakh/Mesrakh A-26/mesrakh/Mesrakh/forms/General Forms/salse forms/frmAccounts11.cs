...
namespace Mesrakh
{
    public partial class frmAccounts11 : Form
    {
        ...
        public void AllEventsAndProperties(bool Properties, bool Events = false)  //  جميع العناصر
        {
            ...
            btn08001002005EventsAndProperties(Properties, Events); // نسخ رقم الحساب   
        ...
        private void txt08001002001EventsAndProperties(bool Properties, bool Events = false) // مربع نص رقم الحساب
        {
            ...
            else if (Properties == true & Events == true)
            {
                ...
                Color col001 = Color.GreenYellow;

                txt08001002001.TextChanged += delegate
                {
                    ...
                    {
                        // هل هو نص او رقم
                        foreach (char cc in txt08001002001.Text)
                        {
                            if (!char.IsDigit(cc))
                            {
                                col001 = txt08001002001.BackColor;
                                txt08001002001.BackColor = Color.Red;
                                return;
                            }
                        }

                        // اذا كان رقم هل هو اكبر من الانتجر
                        if (decimal.Parse(txt08001002001.Text) > 2147483646)
                        {
                            col001 = txt08001002001.BackColor;
                            txt08001002001.BackColor = Color.Red;
                        }
                        ...
                        {
                            if (col001 != Color.GreenYellow)
                            {
                                txt08001002001.BackColor = col001;
                                col001 = Color.GreenYellow;
                            }
                        }
                    }
                    else
        ...
        private void txt08001002002EventsAndProperties(bool Properties, bool Events = false) // مربع نص إسم الحساب انجليزي
        {
            if (Properties == true & Events == false)
            {
                ElementsTools.TextBox_.CustumProperties(txt08001002002, "en-US",100);

            }
            else if (Properties == true & Events == true)
            {
                ElementsTools.TextBox_.CustumProperties(txt08001002002, "en-US",100, ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1, true, true);
        ...
        private void txt08001002003EventsAndProperties(bool Properties, bool Events = false) // مربع نص إسم الحساب عربي
        {
            if (Properties == true & Events == false)
            {
                ElementsTools.TextBox_.CustumProperties(txt08001002003, "ar-SA",100);

            }
            else if (Properties == true & Events == true)
            {
                ElementsTools.TextBox_.CustumProperties(txt08001002003, "ar-SA",100, ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1, true, true);
        ...
        private void txt08001002004EventsAndProperties(bool Properties, bool Events = false) // مربع نص وصف الحساب
        {
            if (Properties == true & Events == false)
            {
                ElementsTools.TextBox_.CustumProperties(txt08001002004, "",250);

            }
            else if (Properties == true & Events == true)
            {
                ElementsTools.TextBox_.CustumProperties(txt08001002004, "",250, ColorPropertyName.BackColor_1, ColorPropertyName.ForeColor_1, true, true);
                    ...
                    try
                    {
                        // التأكد من صحة رقم الحساب
                        {
                            ...
                            foreach (char cc in txt08001002001.Text)
                            {
                                if (!char.IsDigit(cc))
                                {
                                    frmMessageBox.ShowMessageBox(Cultures.ReturnTranslation("خطأ"), Cultures.ReturnTranslation("رقم الحساب ليس رقم"), MessageBoxStatus.Ok);
                                    return;
                                }
                            }
                            ...
                            if (decimal.Parse(txt08001002001.Text) > 2147483646)
                            {
                                frmMessageBox.ShowMessageBox(Cultures.ReturnTranslation("خطأ"), Cultures.ReturnTranslation("رقم الحساب اكبر من الرقم 2,147,483,646"), MessageBoxStatus.Ok);
                                return;
                            }
        ...
        private void btn08001002005EventsAndProperties(bool Properties, bool Events = false) // نسخ رقم الحساب   
        {

            if (Properties == true && Events == false)
            {
                ElementsTools.Button_.CustumProperties(btn08001002005, "نسخ");
            }
            else if (Properties == true && Events == true)
            {
                ElementsTools.Button_.CustumProperties(btn08001002005, "نسخ", ColorPropertyName.ForeColor_1, true, true);
                btn08001002005.Click += delegate
                {
                    Clipboard.SetText(txt08001002001.Text);
                };
            }
        }
