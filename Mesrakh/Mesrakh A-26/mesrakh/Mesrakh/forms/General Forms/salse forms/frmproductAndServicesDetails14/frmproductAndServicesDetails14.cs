                        ...
                        if (btn08001002001.Text == Cultures.ReturnTranslation("إلغاء")) // إضافة
                        {
                            ...
                            if (Error == "")
                            {
                                ...
                                if (result[1] == "succeeded")
                                {
                                    ...
                                    dr[16] = cbx001002006.SelectedValue;
                                    ...
                                    dr2[16] = cbx001002006.SelectedValue;
                            ...
                            if (Error == "")
                            {
                                ...
                                if (CircleElementsTest == false)
                                {
                                    ...
                                    if (result[1] == "succeeded")
                                    {
                                        ...
                                        //---
                                        TblproductAndServicesDetails.Rows[rowIndex][16] = cbx001002006.SelectedValue;
                                        ...
                                        TblMeasureAndEncapsulationUnitsForCbx.Rows[rowIndex][16] = cbx001002006.SelectedValue;
                ...
                dgv08001.SelectionChanged += delegate
                {
                    try
                    {
                        if (dgv08001.Rows.Count > 0)
                        {
                            ...
                            txt08001002012.Text = (Convert.ToDecimal(dgv08001.SelectedRows[0].Cells[15].Value.ToString()) / Convert.ToDecimal(dgv08001.SelectedRows[0].Cells[14].Value.ToString())).ToString(); // تكلفة الوحدة

                            if (cbx001002006 != null)
                            {
                                if (cbx001002006.Items.Count > 0)
                                {
                                    if (dgv08001.SelectedRows[0].Cells[16].Value.ToString() != null)
                                    {
                                        if (dgv08001.SelectedRows[0].Cells[16].Value.ToString().Trim() != "")
                                        {
                                            cbx001002006.SelectedValue = dgv08001.SelectedRows[0].Cells[16].Value.ToString();
                                        }
                                        else
                                        {
