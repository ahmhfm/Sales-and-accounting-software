...
namespace Mesrakh
{
    public partial class frmMainMenu06 : Form
    {
        ...
        private void btn06002007EventsAndProperties(bool Properties, bool Events = false) // الزر 1-7 
        {
            ...
            if (Properties == true && Events == false)
            {
                ElementsTools.Button_.CustumProperties(btn06002007, "عمليات المخزون", ColorPropertyName.ForeColor_4);
                toolTip1.SetToolTip(btn06002007, "Click This Button Then Click F1 For Update");  // تلميح

            }
            else if (Properties == true && Events == true)
            {
                ElementsTools.Button_.CustumProperties(btn06002007, "عمليات المخزون", ColorPropertyName.ForeColor_4, true, true);
                toolTip1.SetToolTip(btn06002007, "Click This Button Then Click F1 For Update");  // تلميح


                btn06002007.Click += delegate
                {
                    if (Permissions.AccountHavePermission(PermissionObjectes.Inventory_Operations, PermissionType.Show))
                    {
                        if (GeneralVariables._frmInventoryOperations25 == null)
                        {
                            GeneralVariables._frmInventoryOperations25 = new frmInventoryOperations25();
                        }

                        GeneralAction.openForm(GeneralVariables._frmInventoryOperations25);
                    }
                    else
                    {
                        frmMessageBox.ShowMessageBox(Cultures.ReturnTranslation("تنبيه"), Cultures.ReturnTranslation("لا توجد لديك صلاحية للوصول رجاء تواصل مع مدير النظام"), MessageBoxStatus.Ok);
                ...
                btn06002007.KeyDown += delegate (object sender, KeyEventArgs e)
                {
                    ...
                    if (e.KeyData == Keys.F1)
                    {
                        ...
                        if (Permissions.AccountHavePermission(PermissionObjectes.Inventory_Operations, PermissionType.Show))
                        {
                            ...
                            {
                                GeneralVariables._frmInventoryOperations25 = null;
                                GeneralVariables._frmInventoryOperations25 = new frmInventoryOperations25();
                            }
                            GeneralAction.openForm(GeneralVariables._frmInventoryOperations25);
                        }
        ...
        private void btn06004001EventsAndProperties(bool Properties, bool Events = false) // الزر 2-1 
        {
            ...
            if (Properties == true && Events == false)
            {
                ElementsTools.Button_.CustumProperties(btn06004001, "الورديات", ColorPropertyName.ForeColor_4);
                toolTip1.SetToolTip(btn06004001, "Click This Button Then Click F1 For Update");  // تلميح

            }
            else if (Properties == true && Events == true)
            {
                ElementsTools.Button_.CustumProperties(btn06004001, "الورديات", ColorPropertyName.ForeColor_4, true, true);
                toolTip1.SetToolTip(btn06004001, "Click This Button Then Click F1 For Update");  // تلميح


                btn06004001.Click += delegate
                {
                    if (Permissions.AccountHavePermission(PermissionObjectes.Shifts, PermissionType.Show))
                    {

                        if (GeneralVariables._frmShifts21 == null)
                        {
                            GeneralVariables._frmShifts21 = new frmShifts21();
                        }

                        GeneralAction.openForm(GeneralVariables._frmShifts21);
                    }
                    else
                    {
                        frmMessageBox.ShowMessageBox(Cultures.ReturnTranslation("تنبيه"), Cultures.ReturnTranslation("لا توجد لديك صلاحية للوصول رجاء تواصل مع مدير النظام"), MessageBoxStatus.Ok);
                ...
                btn06004001.KeyDown += delegate (object sender, KeyEventArgs e)
                {
                    ...
                    if (e.KeyData == Keys.F1)
                    {
                        ...
                        if (Permissions.AccountHavePermission(PermissionObjectes.Shifts, PermissionType.Show))
                        {
                            ...
                            {
                                GeneralVariables._frmShifts21 = null;
                                GeneralVariables._frmShifts21 = new frmShifts21();
                            }
                            GeneralAction.openForm(GeneralVariables._frmShifts21);
                        }
        ...
        private void btn06004002EventsAndProperties(bool Properties, bool Events = false) // الزر 2-2 
        {
            ...
            if (Properties == true && Events == false)
            {
                ElementsTools.Button_.CustumProperties(btn06004002, "المبيعات", ColorPropertyName.ForeColor_4);
                toolTip1.SetToolTip(btn06004002, "Click This Button Then Click F1 For Update");  // تلميح

            }
            else if (Properties == true && Events == true)
            {
                ElementsTools.Button_.CustumProperties(btn06004002, "المبيعات", ColorPropertyName.ForeColor_4, true, true);
                toolTip1.SetToolTip(btn06004002, "Click This Button Then Click F1 For Update");  // تلميح


                btn06004002.Click += delegate
                {
                    if (Permissions.AccountHavePermission(PermissionObjectes.Sales, PermissionType.Show))
                    {
                        if (GeneralVariables._frmSales23 == null)
                        {
                            GeneralVariables._frmSales23 = new frmSales23();
                        }

                        GeneralAction.openForm(GeneralVariables._frmSales23);
                    }
                    else
                    {
                        frmMessageBox.ShowMessageBox(Cultures.ReturnTranslation("تنبيه"), Cultures.ReturnTranslation("لا توجد لديك صلاحية للوصول رجاء تواصل مع مدير النظام"), MessageBoxStatus.Ok);
                        GeneralAction.AddNewNotification("frmMainMenu06 >> btn06004002EventsAndProperties", DateTime.Now, "لا توجد لديك صلاحية للوصول رجاء تواصل مع مدير النظام", "You do not have access, please contact the system administrator");
                    }

                };

                btn06004002.KeyDown += delegate (object sender, KeyEventArgs e)
                {
                    ...
                    if (e.KeyData == Keys.F1)
                    {
                        ...
                        if (Permissions.AccountHavePermission(PermissionObjectes.Sales, PermissionType.Show))
                        {
                            ...
                            {
                                GeneralVariables._frmSales23 = null;
                                GeneralVariables._frmSales23 = new frmSales23();
                            }
                            GeneralAction.openForm(GeneralVariables._frmSales23);
                        }
        ...
        private void btn06006003EventsAndProperties(bool Properties, bool Events = false) // الزر 3-3 
        {
            ...
            if (Properties == true && Events == false)
            {
                ElementsTools.Button_.CustumProperties(btn06006003, "الحسابات المعيارية", ColorPropertyName.ForeColor_4);
                toolTip1.SetToolTip(btn06006003, "Click This Button Then Click F1 For Update");  // تلميح

            }
            else if (Properties == true && Events == true)
            {
                ElementsTools.Button_.CustumProperties(btn06006003, "الحسابات المعيارية", ColorPropertyName.ForeColor_4, true, true);
                toolTip1.SetToolTip(btn06006003, "Click This Button Then Click F1 For Update");  // تلميح


                btn06006003.Click += delegate
                {
                    if (Permissions.AccountHavePermission(PermissionObjectes.Standard_Accounts, PermissionType.Show))
                    {
                        if (GeneralVariables._frmStandardAccounts24 == null)
                        {
                            GeneralVariables._frmStandardAccounts24 = new frmStandardAccounts24();
                        }
                        GeneralAction.openForm(GeneralVariables._frmStandardAccounts24);
                    }
                    else
                    {
                        frmMessageBox.ShowMessageBox(Cultures.ReturnTranslation("تنبيه"), Cultures.ReturnTranslation("لا توجد لديك صلاحية للوصول رجاء تواصل مع مدير النظام"), MessageBoxStatus.Ok);
                        GeneralAction.AddNewNotification("frmMainMenu06 >> btn06006003EventsAndProperties 1 ", DateTime.Now, "لا توجد لديك صلاحية للوصول رجاء تواصل مع مدير النظام", "You do not have access, please contact the system administrator");
                    }

                };

                btn06006003.KeyDown += delegate (object sender, KeyEventArgs e)
                {
                    if (e.KeyData == Keys.F1)
                    {
                        if (Permissions.AccountHavePermission(PermissionObjectes.Standard_Accounts, PermissionType.Show))
                        {
                            ...
                            {
                                GeneralVariables._frmStandardAccounts24 = null;
                                GeneralVariables._frmStandardAccounts24 = new frmStandardAccounts24();
                            }
                            GeneralAction.openForm(GeneralVariables._frmStandardAccounts24);
                        }
                        ...
                        {
                            frmMessageBox.ShowMessageBox(Cultures.ReturnTranslation("تنبيه"), Cultures.ReturnTranslation("لا توجد لديك صلاحية للوصول رجاء تواصل مع مدير النظام"), MessageBoxStatus.Ok);
                            GeneralAction.AddNewNotification("frmMainMenu06 >> btn06006003EventsAndProperties 2", DateTime.Now, "لا توجد لديك صلاحية للوصول رجاء تواصل مع مدير النظام", "You do not have access, please contact the system administrator");
                        }
                    }
                };
        ...
        private void btn06008009EventsAndProperties(bool Properties, bool Events = false) // الزر 4-9 
        {
            if (Properties == true && Events == false)
            {
                ElementsTools.Button_.CustumProperties(btn06008009, "وحدات العمليات", ColorPropertyName.ForeColor_4);
                toolTip1.SetToolTip(btn06008009, "Click This Button Then Click F1 For Update");  // تلميح

            }
            else if (Properties == true && Events == true)
            {
                ElementsTools.Button_.CustumProperties(btn06008009, "وحدات العمليات", ColorPropertyName.ForeColor_4, true, true);
                toolTip1.SetToolTip(btn06008009, "Click This Button Then Click F1 For Update");  // تلميح


                btn06008009.Click += delegate
                {
                    if (Permissions.AccountHavePermission(PermissionObjectes.Operation_Units, PermissionType.Show))
                    {
                        if (GeneralVariables._frmOperationUnits22 == null)
                        {
                            GeneralVariables._frmOperationUnits22 = new frmOperationUnits22();
                        }

                        GeneralAction.openForm(GeneralVariables._frmOperationUnits22);
                    }
                    else
                    {
                        frmMessageBox.ShowMessageBox(Cultures.ReturnTranslation("تنبيه"), Cultures.ReturnTranslation("لا توجد لديك صلاحية للوصول رجاء تواصل مع مدير النظام"), MessageBoxStatus.Ok);
                ...
                btn06008009.KeyDown += delegate (object sender, KeyEventArgs e)
                {
                    ...
                    if (e.KeyData == Keys.F1)
                    {
                        ...
                        if (Permissions.AccountHavePermission(PermissionObjectes.Operation_Units, PermissionType.Show))
                        {
                            ...
                            {
                                GeneralVariables._frmOperationUnits22 = null;
                                GeneralVariables._frmOperationUnits22 = new frmOperationUnits22();
                            }
                            GeneralAction.openForm(GeneralVariables._frmEnterprise15);
                        }
