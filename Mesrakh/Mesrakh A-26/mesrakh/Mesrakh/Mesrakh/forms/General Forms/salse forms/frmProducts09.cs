...
namespace Mesrakh
{
    public partial class frmProducts09 : Form
    {
        ...
        {
            InitializeComponent();
            AllfrmProducts09ElementsEventsAndProperties(true, true); // جميع عناصر النموذج
        }

        public void AllfrmProducts09ElementsEventsAndProperties(bool Properties, bool Events = false)  //  جميع العناصر
        {
                    ...
                    try
                    {
                        if ( btn08001002001.Text == Cultures.ReturnTranslation("إلغاء") ) // إضافة
                        {
                            ...
                            if (Error == "")
                            {
                                ...
                                AllfrmProducts09ElementsEventsAndProperties(true); // تم تحديث جميع الخصائص لتعود الازرار لوضعها الطبيعي
                        ...
                        else if (btn08001002003.Text == Cultures.ReturnTranslation("إلغاء")) // تعديل
                        {
                            ...
                            if (Error == "")
                            {
                                ...
                                // تحديث بيانات جدول البيانات
                                fillTblProducts();
                                AllfrmProducts09ElementsEventsAndProperties(true);
