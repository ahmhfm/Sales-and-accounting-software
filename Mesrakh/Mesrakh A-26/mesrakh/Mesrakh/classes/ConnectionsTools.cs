...
public static class ConnectionsTools
{
    ...
    public static bool weHaveOpenConnection = true; // لدينا اتصال مفتوح
    // الاتصالات
    ...
    public static SqlConnection Conlicenses()
    {
        ...
        try
        {
            ...
            else
            {
                ...
                if (checkNet()) // اذا كان هناك اتصال انترنت مفتوح
                {
                ...
                else // اذا  لم يكن هناك اتصال انترنت مفتوح
                {
    ...
    public static string[] ReadAllInstancesOnLocalMachine()
    {
        try
        {
            ...
            string serverName = Environment.MachineName; // اسم الجهاز
            RegistryView registryView = Environment.Is64BitOperatingSystem ? RegistryView.Registry64 : RegistryView.Registry32; // نوع نظام التشغيل 64 او 32
    ...
    // التحقق من وجود انترنت
    /// <summary>
    /// 05004 >> check if thare is internet open connection
    /// </summary>
    /// <returns>
    /// boolean value
    /// </returns>
