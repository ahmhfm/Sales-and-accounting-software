...
public class Cultures
{
    ...
    public static void fillTranslationTable()
    {
        if (tblTranslation is null)
        {
            ...
            tblTranslation.Rows.Add(new string[] { "493", "", "", "" });
            ...
            tblTranslation.Rows.Add(new string[] { "565", "عمليات المخزون", "Inventory Operations", "" });
            tblTranslation.Rows.Add(new string[] { "566", "إسم المنتج", "product name", "" });
            tblTranslation.Rows.Add(new string[] { "567", "عمليات فتح الصناديق", "Unboxing operations", "" });
            tblTranslation.Rows.Add(new string[] { "568", "تحويل", "conversion", "" });
            tblTranslation.Rows.Add(new string[] { "569", "رجاء قم بتسجيل الكمية", "Please record the quantity", "" });
            tblTranslation.Rows.Add(new string[] { "570", "رجاء قم بتحديد المنتج", "Please select the product", "" });
            tblTranslation.Rows.Add(new string[] { "571", "تم التحويل بنجاح", "Converted successfully", "" });
            tblTranslation.Rows.Add(new string[] { "572", "الكمية المتوفرة", "Quantity Available", "" });
            tblTranslation.Rows.Add(new string[] { "573", "الكمية المراد تحويلها", "Quantity to be transferred", "" });
            tblTranslation.Rows.Add(new string[] { "574", "الكميرة المراد تحويلها أكبر من الكمية المتوفرة بالمخزون", "The quantity to be converted is greater than the quantity available in stock", "" });
            tblTranslation.Rows.Add(new string[] { "575", "عدم توافق مع سجلات جدول الحسابات البنكية", "Inconsistency with the bank accounts table records", "" });
            tblTranslation.Rows.Add(new string[] { "576", "عدم توافق مع سجلات جدول صناديق النقدية", "Incompatibility with the cash box table records", "" });
            tblTranslation.Rows.Add(new string[] { "577", "عدم توافق مع سجلات جدول الارفف", "Incompatibility with the shelves table records", "" });
            tblTranslation.Rows.Add(new string[] { "578", "عدم توافق مع سجلات جدول وحدات العمليات", "Incompatibility with the operations unit table records", "" });
            tblTranslation.Rows.Add(new string[] { "579", "", "", "" });
            tblTranslation.Rows.Add(new string[] { "580", "", "", "" });
        }
    }
