...
public static class GeneralVariables
{
    ...
    public static DataTable ActiveAccount; // 08023 //  الحساب النشط 
    ...
    public static frmEnterpriseBranches16 _frmEnterpriseBranches16;  // 08031 // نموذج فروع المنشآت 

    public static frmCountries17 _frmCountries17;  // 08031 // نموذج الدول 

    public static frmEmployees18 _frmEmployees18;  // 08031 // نموذج الموظفين  

    public static frmClients19 _frmClients19;  // 08031 // نموذج العملاء

    public static frmJournalEntry20 _frmJournalEntry20;  // 08031 // نموذج قيود اليومية

    public static frmShifts21 _frmShifts21;  // 08031 // نموذج الورديات

    public static frmOperationUnits22 _frmOperationUnits22;  // 08031 // نموذج وحدات العمليات

    public static frmSales23 _frmSales23;  // 08031 // نموذج المبيعات

    public static frmStandardAccounts24 _frmStandardAccounts24;  // 08031 // نموذج الحسابت المعيارية

    
    public static DataTable TblStandardAccounts ;//جدول الحسابات المعيارية 
    public static DataTable TblClients;// جدول العملاء 
    public static DataTable TblOperationUnits;// جدول وحدة العمليات الحالية
    public static DataTable TblShiftsOpenOnThisDevice; // جدول الوردية المفتوحة على هذا الجهاز // يتم تحديثه بعد كل عملية حيث يزيد الرصيد القيدي او ينقص
    public static DataTable TblBankAccounts; // جدول الحسابات البنكية

    public static frmInventoryOperations25 _frmInventoryOperations25;  // 08031 // نموذج عمليات المخزون
